{
  ...
  inputs = {
    ...
    kyvernoPkgsSrc.url =
      "github:NixOS/nixpkgs/34a626458d686f1b58139620a8b2793e9e123bba";
    natsPkgsSrc.url =
      "github:NixOS/nixpkgs/34a626458d686f1b58139620a8b2793e9e123bba";
  };
  ...
  outputs = { nixpkgs, flake-utils, kubeUtilsPkgsSrc, awsUtilsPkgsSrc
    ...
    , vaultPkgsSrc, linkerdPkgsSrc, kyvernoPkgsSrc, natsPkgsSrc, ... }@inputs:
      ...
      let
        ...
        panfactumPackages = import ./packages/nix/packages {
          inherit pkgs kubeUtilsPkgs awsUtilsPkgs tfUtilsPkgs buildkitPkgs
            redisPkgs postgresPkgs vaultPkgs linkerdPkgs kyvernoPkgs natsPkgs;
        };
