...
let
  ...
  packages = {
    ...
    "@aws-sdk/client-ecr/@smithy/util-waiter" = {
      out_path = "@aws-sdk/client-ecr/node_modules/@smithy/node_modules/util-waiter";
      binaries =
        {
        };
      pkg = fetchurl {
    ...
    "@aws-sdk/client-ecr/@smithy/util-waiter/@smithy/abort-controller" = {
      out_path = "@aws-sdk/client-ecr/node_modules/@smithy/node_modules/util-waiter/node_modules/@smithy/node_modules/abort-controller";
      binaries =
        {
        };
      pkg = fetchurl {
