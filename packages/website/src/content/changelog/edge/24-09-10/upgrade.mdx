...
The `kubectl delete` commands may take a few minutes to complete as this will force all pods to be rescheduled
from nodes using the old CRDs to nodes using the new CRDs.
