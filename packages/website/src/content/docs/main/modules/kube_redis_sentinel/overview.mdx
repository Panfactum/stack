...
(provided by [kube_pvc_autoresizer](/docs/main/modules/kube_pvc_autoresizer/overview))
...
[kube_disruption_window_controller](/docs/main/modules/kube_disruption_window_controller/overview)
submodule.
