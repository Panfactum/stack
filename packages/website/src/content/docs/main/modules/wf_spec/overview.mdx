...
with the Panfactum deployment of Argo Workflows (deployed via [kube_argo](/docs/main/modules/kube_argo/overview))
...
[kube_constants](/docs/main/modules/kube_constants/overview) submodule. The below code
