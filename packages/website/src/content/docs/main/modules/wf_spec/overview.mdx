...
with the Panfactum deployment of Argo Workflows (deployed via [kube\_argo](/docs/main/modules/kube_argo/overview))
...
[kube\_constants](/docs/main/modules/kube_constants/overview) submodule. The below code
