...
Description: Opt-in type for AWS Service Quotas Automatic Management. NotifyAndAdjust enables proactive quota increases.
NotifyOnly sends alerts only. Disabled turns off auto-management entirely.
