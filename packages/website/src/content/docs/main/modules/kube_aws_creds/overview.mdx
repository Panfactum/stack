...
no other security controls are applied (unlike [kube_sa_auth_aws](/docs/main/modules/kube_sa_auth_aws/overview)).

<MarkdownAlert severity="warning">
   This module should *only* be used when [kube_sa_auth_aws](/docs/main/modules/kube_sa_auth_aws/overview)
