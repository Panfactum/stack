...
Description: Iff true, then all requests with paths that do not end with a file extension (dot followed by alphanumeric
characters) will have the `default_file` appended.
