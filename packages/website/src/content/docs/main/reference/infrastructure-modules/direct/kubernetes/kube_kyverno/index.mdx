...
<ModuleHeader name="kube_kyverno" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_kyverno" status="stable" type="direct" />
