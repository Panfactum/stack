...
We provide an example of using this module [here](https://github.com/Panfactum/reference-infrastructure/blob/__PANFACTUM_VERSION_MAIN__/infrastructure/demo_cicd/website_image_builder.tf).
...
will need to adjust the parameters of the [kube\_buildkit](/docs/main/reference/infrastructure-modules/direct/kubernetes/kube\_buildkit) module.
