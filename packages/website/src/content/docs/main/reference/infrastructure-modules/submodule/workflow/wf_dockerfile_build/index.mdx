...
<<<<<<< HEAD
will need to adjust the parameters of the [kube\_buildkit](/main/reference/infrastructure-modules/direct/kubernetes/kube\_buildkit) module.
||||||| a3b739f2
will need to adjust the parameters of the [kube\_buildkit](/main/reference/infrastructure-modules/direct/kubernetes/kube_buildkit) module.
=======
will need to adjust the parameters of the [kube\_buildkit](/docs/main/reference/infrastructure-modules/direct/kubernetes/kube_buildkit) module.
>>>>>>> main
