...
[kube\_deployment](/main/reference/infrastructure-modules/submodule/kubernetes/kube\_deployment) and [kube\_stateful\_set](/main/reference/infrastructure-modules/submodule/kubernetes/kube\_stateful\_set).
