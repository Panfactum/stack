...
output from instances of the [kube\_ingress](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube\_ingress)
module and forwarding them to the [aws\_cdn](/docs/main/reference/infrastructure-modules/submodule/aws/aws\_cdn) module.

This module takes the same arguments as `aws_cdn`, so see it's [module documentation](/docs/main/reference/infrastructure-modules/submodule/aws/aws\_cdn)
...
* For additional limitations, see the [aws\_cdn](/docs/main/reference/infrastructure-modules/submodule/aws/aws\_cdn) module docs.
