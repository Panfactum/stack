...
<ModuleHeader name="kube_cert_manager" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_cert_manager" status="deprecated" type="direct" />
