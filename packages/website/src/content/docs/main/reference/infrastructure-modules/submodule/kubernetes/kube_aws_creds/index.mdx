...
no other security controls are applied (unlike [kube\_sa\_auth\_aws](/main/reference/infrastructure-modules/submodule/kubernetes/kube\_sa\_auth\_aws)).

<MarkdownAlert severity="warning">
   This module should *only* be used when [kube\_sa\_auth\_aws](/main/reference/infrastructure-modules/submodule/kubernetes/kube\_sa\_auth\_aws)
