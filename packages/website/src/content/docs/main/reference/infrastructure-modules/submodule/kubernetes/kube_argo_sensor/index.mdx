...
<ModuleHeader name="kube_argo_sensor" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_argo_sensor" status="beta" type="submodule"/>
