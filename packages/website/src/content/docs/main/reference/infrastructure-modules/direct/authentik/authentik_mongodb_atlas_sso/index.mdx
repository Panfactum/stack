...
Please follow the steps defined in the [MongoDB Atlas Identity Provider](/main/reference/infrastructure-modules/direct/authentik/mongodb\_atlas\_identity\_provider) and resume here.
