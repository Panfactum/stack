...
This module is intended to be used in conjunction with the [kube\_ingress](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube\_ingress)
