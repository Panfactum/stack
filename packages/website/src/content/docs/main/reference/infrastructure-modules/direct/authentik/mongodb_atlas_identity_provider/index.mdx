...
If you have CICD setup and are deploying infrastructure using the [wf\_tf\_deploy](/main/reference/infrastructure-modules/submodule/workflow/wf\_tf\_deploy) module,
...
the [Sync Authentik with the Atlas Settings](/main/reference/infrastructure-modules/direct/authentik/authentik\_mongodb\_atlas\_sso)
section.
