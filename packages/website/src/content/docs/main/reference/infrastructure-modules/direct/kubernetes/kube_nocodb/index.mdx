...
<ModuleHeader name="kube_nocodb" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_nocodb" status="alpha" type="direct"/>
