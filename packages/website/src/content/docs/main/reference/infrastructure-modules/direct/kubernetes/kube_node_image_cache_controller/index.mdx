...
images to the cache by leveraging the [kube\_node\_image\_cache](/main/reference/infrastructure-modules/submodule/kubernetes/kube\_node\_image\_cache) submodule.
