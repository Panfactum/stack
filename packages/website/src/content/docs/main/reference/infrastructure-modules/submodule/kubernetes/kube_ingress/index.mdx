...
1. For all domains in `domains`, ensure that a DNS record is configured to point to the domain to this cluster's NGINX
  ingress controller (via [kube\_external\_dns](/main/reference/infrastructure-modules/direct/kubernetes/kube\_external\_dns))
  and provide the ingress controller a TLS certificate for the domains
  (via [kube\_cert\_manager](/main/reference/infrastructure-modules/direct/kubernetes/kube\_cert\_manager)).
...
[kube\_cert\_issuers](/main/reference/infrastructure-modules/submodule/kubernetes/kube\_cert\_issuers) provides a global
...
for performance and security improvements, see the [kube\_aws\_cdn](/main/reference/infrastructure-modules/submodule/kubernetes/kube\_aws\_cdn) module.
...
settings are described in more detail [here](/main/reference/infrastructure-modules/submodule/aws/aws\_cdn).
