...
<ModuleHeader name="kube_keda" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_keda" status="beta" type="direct" />
