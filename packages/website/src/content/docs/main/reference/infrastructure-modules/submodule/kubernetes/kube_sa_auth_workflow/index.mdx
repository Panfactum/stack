...
<ModuleHeader name="kube_sa_auth_workflow" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_sa_auth_workflow" status="beta" type="submodule"/>
...
assigned in the [aws\_vpc](/docs/main/reference/infrastructure-modules/aws/aws\_vpc) and [aws\_eks](/docs/main/reference/infrastructure-modules/aws/aws\_eks)
