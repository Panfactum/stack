...
we make use of this submodule in our database modules (e.g., [kube\_pg\_cluster](/main/reference/infrastructure-modules/submodule/kubernetes/kube\_pg\_cluster)).
