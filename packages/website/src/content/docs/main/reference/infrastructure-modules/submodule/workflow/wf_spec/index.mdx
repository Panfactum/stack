...
with the Panfactum deployment of Argo Workflows (deployed via [kube\_argo](/main/reference/infrastructure-modules/direct/kubernetes/kube\_argo))
...
[kube\_constants](/main/reference/infrastructure-modules/submodule/kubernetes/kube\_constants) submodule. The below code
