...
* Deploying the components of the Event Bus requires that the Argo Events controller is running. This is done
  via deploying the [Workflow Engine Stack Addon.](/main/guides/addons/workflow-engine/installing)

* Deploying an Event Bus requires writing your own IaC. Be sure you have reviewed [our guide on how to do this in
  the Panfactum stack.](/main/guides/iac/first-party-modules)
...
* [kube\_argo\_event\_source](/main/reference/infrastructure-modules/submodule/kubernetes/kube_argo_event_source)
* [kube\_argo\_sensor](/main/reference/infrastructure-modules/submodule/kubernetes/kube_argo_sensor)
* [kube\_argo\_event\_bus](/main/reference/infrastructure-modules/submodule/kubernetes/kube_argo_event_bus)
