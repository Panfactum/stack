...
<MarkdownAlert severity="warning">
  The Panfactum [kube\_argo](/docs/main/modules/kube_argo/overview) does not create an Ingress for the Argo Workflow
...
[kube_sa_auth_workflow](/docs/main/modules/kube_sa_auth_workflow/overview) submodule to assign the necessary permissions
...
Using our [Event Bus Addon](/docs/main/guides/addons/event-bus/installing), you can create an Argo
...
[CI / CD pipelines](/docs/main/guides/cicd/rolling-deployments).
