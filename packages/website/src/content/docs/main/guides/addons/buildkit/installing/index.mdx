...
We provide a module, [kube\_buildkit](/docs/main/modules/kube_buildkit/overview), for
...
We provide a module for configuring ECR with your image repositories: [aws\_ecr\_repos](/docs/main/modules/aws_ecr_repos/overview). [^2]
...
[^2]: We also supply [aws\_ecr\_public\_repos](/docs/main/modules/aws_ecr_public_repos/overview) for deploying
