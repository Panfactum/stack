...
[^3]: A more detailed architectural overview can be found [here](/main/concepts/buildkit).
...
We provide a module, [kube\_buildkit](/main/reference/infrastructure-modules/direct/kubernetes/kube_buildkit), for
...
We provide a module for configuring ECR with your image repositories: [aws\_ecr\_repos](/main/reference/infrastructure-modules/direct/aws/aws_ecr_repos). [^2]
...
[^2]: We also supply [aws\_ecr\_public\_repos](/main/reference/infrastructure-modules/direct/aws/aws_ecr_public_repos) for deploying
...
([reference docs](/main/reference/configuration/buildkit)).
...
* [Core techniques for building images](/main/guides/addons/buildkit/building-images)
