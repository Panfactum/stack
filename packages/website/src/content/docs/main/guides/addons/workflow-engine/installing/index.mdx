...
[^1]: Argo Events can also be used to trigger many more actions than just Argo Workflows. See our
    [Event Bus Addon](/main/guides/addons/event-bus/installing) guide.
...
We provide a module, [kube\_argo](/main/reference/infrastructure-modules/direct/kubernetes/kube_argo), that
...
* To start creating your own custom Workflows, take a look at [our documentation](/main/guides/addons/workflow-engine/creating-workflows).

* Deploy some of [our pre-built Workflows](/main/guides/addons/workflow-engine/prebuilt-workflows) for common tasks in the Panfactum Stack

* Learn how to use Workflows for your CI / CD system [here.](/main/guides/cicd/getting-started)

* Learn more about how to leverage Argo Events [here.](/main/guides/addons/event-bus/installing)
