...
2. Add a new `terragrunt.hcl` file that looks like [this](https://github.com/Panfactum/reference-infrastructure/blob/__PANFACTUM_VERSION_MAIN__/environments/production/us-east-2/authentik_aws_sso/terragrunt.hcl).
...
2. Add a new `terragrunt.hcl` file that looks like [this](https://github.com/Panfactum/reference-infrastructure/blob/__PANFACTUM_VERSION_MAIN__/environments/management/global/aws_iam_identity_center_permissions/terragrunt.hcl).
...
5. Set up `config.yaml` according to [these reference docs](/docs/main/reference/configuration/aws).
   ...
   1. We provide an example file [here.](https://github.com/Panfactum/reference-infrastructure/blob/__PANFACTUM_VERSION_MAIN__/.aws/config.yaml)
...
2. Add a new `terragrunt.hcl` file that looks like [this](https://github.com/Panfactum/reference-infrastructure/blob/__PANFACTUM_VERSION_MAIN__/environments/production/us-east-2/authentik_vault_sso_production/terragrunt.hcl).
...
2. Add a new `terragrunt.hcl` file that looks like [this](https://github.com/Panfactum/reference-infrastructure/blob/__PANFACTUM_VERSION_MAIN__/environments/production/us-east-2/vault_auth_oidc/terragrunt.hcl).
