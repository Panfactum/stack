...
2. Add a new `terragrunt.hcl` file that looks like this:
   ...
   ::: code-group labels=\[authentik\_aws\_sso/terragrunt.hcl]
...
11. Enable SCIM in the `authentik_aws_sso` module.
    ...
    ::: code-group labels=\[authentik\_aws\_sso/terragrunt.hcl, authentik\_aws\_sso/secrets.yaml]
...
2. Add a new `terragrunt.hcl` file that looks like this:
   ...
   ::: code-group labels=\[management/global/aws\_iam\_identity\_center\_permissions/terragrunt.hcl]
...
5. Set up `config.yaml` according to [these reference docs](/docs/main/reference/configuration/aws). Here is an example file:
...
2. Add `terragrunt.hcl` and `module.yaml` files that looks like this:
   ...
   ::: code-group labels=\[authentik\_vault\_sso\_production/terragrunt.hcl, authentik\_vault\_sso\_production/module.yaml]
...
2. Add new `terragrunt.hcl` and sops-encrypted `secrets.yaml` files that looks like this:
   ...
   ::: code-group labels=\[vault\_auth\_oidc/terragrunt.hcl, vault\_auth\_oidc/secrets.yaml]
