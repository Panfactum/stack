...
We provide both a module to deploy Authentik ([kube_authentik](/docs/main/modules/kube_authentik/overview)) and many
...
We provide a module to do this: [aws_ses_domain](/docs/main/modules/aws_ses_domain/overview).
...
7. (Optional) This module does not configure your DMARC record as you would typically only have one DMARC record that
   ...
   use the [aws_dns_records](/docs/main/modules/aws_dns_records/overview) module to deploy the record.
...
[authentik_core_resources](/docs/main/modules/authentik_core_resources/overview).
...
[Panfactum RBAC reference](/docs/main/reference/rbac) for more information.
...
<BootstrappingGuideNav
  backHref={"/docs/main/guides/bootstrapping/databases"}
  forwardHref={"/docs/main/guides/bootstrapping/federated-auth"}
  stepNumber={19}
/>
