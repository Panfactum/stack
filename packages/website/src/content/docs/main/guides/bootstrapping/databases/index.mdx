...
We provide a module to deploy the operator: [kube\_cloudnative\_pg](/docs/main/modules/kube_cloudnative_pg/overview).
...
We provide a module [kube\_pg\_cluster](/docs/main/modules/kube_pg_cluster/overview) that you can use in your
projects to do this.
...
module called [test\_kube\_pg\_cluster](/docs/main/modules/kube_pg_cluster/overview) which is a thin
wrapper around [kube\_pg\_cluster](/docs/main/modules/kube_pg_cluster/overview).
...
* **Relational:** PostgreSQL ([kube\_pg\_cluster](/docs/main/modules/kube_pg_cluster/overview))
* **Key-value:** Redis ([kube\_redis\_sentinel](/docs/main/modules/kube_redis_sentinel/overview))
* **Message Broker:** NATS Jetstream ([kube\_nats](/docs/main/modules/kube_nats/overview))
