...
3. Add a new `terragrunt.hcl` file that looks like [this](https://github.com/Panfactum/reference-infrastructure/blob/__PANFACTUM_VERSION_MAIN__/environments/production/global/aws_registered_domains/terragrunt.hcl).
...
3. Create a `terragrunt.hcl` that looks like [this](https://github.com/Panfactum/reference-infrastructure/blob/__PANFACTUM_VERSION_MAIN__/environments/production/global/aws_delegated_zones_production/terragrunt.hcl). [^4]
