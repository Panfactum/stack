...
We provide a module for deploying Kyverno, [kube\_kyverno](/docs/main/modules/kube_kyverno/overview).
...
[Kyverno Policies](https://kyverno.io/docs/kyverno-policies/), we provide a module called [kube\_policies](/docs/main/modules/kube_kyverno/overview).
