...
We provide an [aws\_vpc](/docs/main/modules/aws_vpc/overview) module to deploy the VPC.
...
We will now deploy the [aws\_vpc](/docs/main/modules/aws_vpc/overview) module via terragrunt:
...
<MarkdownAlert severity="warning">
  If you deviate from the default settings for the [aws\_vpc](/docs/main/modules/aws_vpc/overview) module,
