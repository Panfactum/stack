...
We provide the [kube_aws_ebs_csi](/docs/main/modules/kube_aws_ebs_csi/overview) module to deploy the driver.
...
<BootstrappingGuideNav
  backHref={"/docs/main/guides/bootstrapping/policy-controller"}
  forwardHref={"/docs/main/guides/bootstrapping/vault"}
  stepNumber={11}
/>
