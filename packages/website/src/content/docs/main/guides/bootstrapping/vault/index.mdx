...
We will use the [kube\_vault](/main/reference/infrastructure-modules/direct/kubernetes/kube_vault) infrastructure module to deploy
...
via the [vault\_core\_resources](/main/reference/infrastructure-modules/direct/vault/vault_core_resources) module.
...
Let's now deploy [vault\_core\_resources](/main/reference/infrastructure-modules/direct/vault/vault_core_resources):
...
in the [prior section](/main/guides/bootstrapping/storage-interfaces).
