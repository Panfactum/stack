...
We will use the [kube\_vault](/docs/main/modules/kube_vault/overview) infrastructure module to deploy
...
via the [vault\_core\_resources](/docs/main/modules/vault_core_resources/overview) module.
...
Let's now deploy [vault\_core\_resources](/docs/main/modules/vault_core_resources/overview):
