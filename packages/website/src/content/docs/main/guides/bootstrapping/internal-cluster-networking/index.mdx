...
<p class="subtitle">Install the basic Kubernetes cluster networking primitives via the [kube\_core\_dns](/docs/main/modules/kube_core_dns/overview)
and [kube\_cilium](/docs/main/modules/kube_cilium/overview) modules.</p>
...
for deploying Cilium: [kube\_cilium](/docs/main/modules/kube_cilium/overview).
...
We provide a module to deploy CoreDNS called [kube\_core\_dns](/docs/main/modules/kube_core_dns/overview).
