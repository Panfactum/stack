...
using our [aws\_eks](/docs/main/modules/aws_eks/overview) module.</p>
...
We provide a module for configuring this behavior: [aws\_ecr\_pull\_through\_cache](/docs/main/modules/aws_ecr_pull_through_cache/overview).
