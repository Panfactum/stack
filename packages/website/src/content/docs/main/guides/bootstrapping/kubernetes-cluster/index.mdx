...
3. Add a `terragrunt.hcl` to that directory that looks like [this](https://github.com/Panfactum/reference-infrastructure/blob/__PANFACTUM_VERSION_MAIN__/environments/production/us-east-2/aws_ecr_pull_through_cache/terragrunt.hcl).

4. Run `pf-tf-init` to enable the required providers.

5. Run `terragrunt apply`.

6. In your `region.yaml`, set `extra_inputs.pull_through_cache_enabled` to `true` like [this](https://github.com/Panfactum/reference-infrastructure/blob/__PANFACTUM_VERSION_MAIN__/environments/production/us-east-2/region.yaml).
...
3. Add a `terragrunt.hcl` to that directory that looks like [this](https://github.com/Panfactum/reference-infrastructure/blob/__PANFACTUM_VERSION_MAIN__/environments/production/us-east-2/aws_eks/terragrunt.hcl).
...
See [this file](https://github.com/Panfactum/reference-infrastructure/blob/__PANFACTUM_VERSION_MAIN__/environments/production/us-east-2/region.yaml) as an example.
