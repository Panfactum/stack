...
using our [aws\_eks](/main/reference/infrastructure-modules/direct/aws/aws_eks) module.</p>
...
<MarkdownAlert severity="info">
  To save costs during the bootstrapping process you can follow the [Kubernetes Cluster Suspension Guide](/main/guides/bootstrapping/suspend-kubernetes-cluster)
...
We provide a module for configuring this behavior: [aws\_ecr\_pull\_through\_cache](/main/reference/infrastructure-modules/direct/aws/aws_ecr_pull_through_cache).
...
information about this file can be found [here](/main/reference/configuration/kubernetes).
...
<MarkdownAlert severity="warning">
  *Every* one of your users will need to set up their own `config.user.yaml` file, and we provide instructions
  for them [here](/main/guides/getting-started/connect-to-infrastructure).
</MarkdownAlert>
...
some additional [terragrunt variables](/main/reference/configuration/terragrunt-variables).
