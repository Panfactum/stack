...
We provide a module to deploy this controller: [kube\_reloader](/docs/main/modules/kube_reloader/overview).
...
Fortunately, we can provide a solution to this problem, the [kube\_node\_image\_cache\_controller](/docs/main/modules/kube_node_image_cache_controller/overview).
...
[^22]: While many of our modules automatically specify images for the cache, you can specify additional images
    via the  [kube\_node\_image\_cache](/docs/main/modules/kube_node_image_cache/overview) submodule. This
...
We provide a module to deploy it: [kube\_pvc\_autoresizer](/docs/main/modules/kube_pvc_autoresizer/overview).
...
We provide a module for the Descheduler: [kube\_descheduler](/docs/main/modules/kube_descheduler/overview).
...
via the [kube\_aws\_ebs\_csi](/docs/main/modules/kube_aws_ebs_csi/overview) module we installed in
...
We provide a module to deploy the external-snapshotter: [kube\_external\_snapshotter](/docs/main/modules/kube_external_snapshotter/overview).
...
We provide a module to deploy this functionality: [kube\_velero](/docs/main/modules/kube_velero/overview).
