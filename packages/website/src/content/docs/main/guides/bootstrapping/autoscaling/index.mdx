...
We provide a module to deploy the server: [kube\_metrics\_server](/docs/main/modules/kube_metrics_server/overview).
...
We provide a module to deploy the VPA: [kube\_vpa](/docs/main/modules/kube_vpa/overview).
...
6. Navigate up to the directory containing all your modules (i.e., the region directory). Run
   `terragrunt apply --all` to re-apply all the modules in the region at once. Note that this might cause your Vault proxy
...
We provide an infrastructure module to deploy it: [kube\_karpenter](/docs/main/modules/kube_karpenter/overview).
...
the [kube\_karpenter\_node\_pools](/docs/main/modules/kube_karpenter_node_pools/overview) module.
...
We provide an alternative scheduler in [kube\_scheduler](/docs/main/modules/kube_scheduler/overview)
...
We provide a module [kube\_keda](/docs/main/modules/kube_keda/overview) for deploying and managing KEDA.
