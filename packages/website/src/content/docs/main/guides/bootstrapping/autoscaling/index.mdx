...
and resource optimization, see our [concept docs.](/main/concepts/autoscaling)
...
We provide a module to deploy the server: [kube\_metrics\_server](/main/reference/infrastructure-modules/direct/kubernetes/kube_metrics_server).
...
We provide a module to deploy the VPA: [kube\_vpa](/main/reference/infrastructure-modules/direct/kubernetes/kube_vpa).
...
We provide an infrastructure module to deploy it: [kube\_karpenter](/main/reference/infrastructure-modules/direct/kubernetes/kube_karpenter).
...
the [kube\_karpenter\_node\_pools](/main/reference/infrastructure-modules/direct/kubernetes/kube_karpenter_node_pools) module.
...
We provide an alternative scheduler in [kube\_scheduler](/main/reference/infrastructure-modules/direct/kubernetes/kube_scheduler)
...
We provide a module [kube\_keda](/main/reference/infrastructure-modules/direct/kubernetes/kube_keda) for deploying and managing KEDA.
