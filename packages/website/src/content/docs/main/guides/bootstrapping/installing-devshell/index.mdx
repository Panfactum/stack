...
Follow this [guide section](/main/guides/getting-started/install-tooling?bootstrapping=true) to install a few prerequisite tools.
...
For the full list of available values and their behavior, please refer to [these reference docs](/main/reference/configuration/repo-variables).
...
For the full list of Panfactum-specific environment variables, please refer to [these reference docs](/main/reference/configuration/dotenv).
