...
<MarkdownAlert severity="info">
  We provide a [reference repository setup](https://github.com/Panfactum/reference-infrastructure/tree/__PANFACTUM_VERSION_MAIN__) that you can benchmark against as you progress through the setup documentation.
</MarkdownAlert>
...
See an example file [here.](https://github.com/Panfactum/reference-infrastructure/blob/__PANFACTUM_VERSION_MAIN__/panfactum.yaml)
