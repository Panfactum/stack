...
- [tf_bootstrap_resources](/docs/main/modules/tf_bootstrap_resources/overview) (the state backend using AWS
  [S3](https://aws.amazon.com/s3/) and [DynamoDB](https://aws.amazon.com/dynamodb/))

- [aws_kms_encrypt_key](/docs/main/modules/aws_kms_encrypt_key/overview) (the encryption key using AWS
...
first resource will be the [aws_account](/docs/main/modules/aws_account/overview) module. This module adds some critical
...
<BootstrappingGuideNav
  backHref={"/docs/main/guides/bootstrapping/configuring-infrastructure-as-code"}
  forwardHref={"/docs/main/guides/bootstrapping/dns"}
  stepNumber={5}
/>
