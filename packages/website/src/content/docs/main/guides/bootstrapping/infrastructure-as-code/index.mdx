...
* [tf\_bootstrap\_resources](/main/reference/infrastructure-modules/direct/aws/tf_bootstrap_resources) (the state backend using AWS [S3](https://aws.amazon.com/s3/) and [DynamoDB](https://aws.amazon.com/dynamodb/))
* [aws\_kms\_encrypt\_key](/main/reference/infrastructure-modules/submodule/aws/aws_kms_encrypt_key) (the encryption key using AWS [KMS](https://aws.amazon.com/kms/))
...
The first resource will be the [aws\_account](/main/reference/infrastructure-modules/direct/aws/aws_account) module. This module adds some critical metadata
