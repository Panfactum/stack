...
* [tf\_bootstrap\_resources](/docs/main/modules/tf_bootstrap_resources/overview) (the state backend using AWS [S3](https://aws.amazon.com/s3/) and [DynamoDB](https://aws.amazon.com/dynamodb/))
* [aws\_kms\_encrypt\_key](/docs/main/modules/aws_kms_encrypt_key/overview) (the encryption key using AWS [KMS](https://aws.amazon.com/kms/))
...
The first resource will be the [aws\_account](/docs/main/modules/aws_account/overview) module. This module adds some critical metadata
