...
* [kube\_deployment](/docs/main/modules/kube_deployment/overview)
* [kube\_stateful\_set](/docs/main/modules/kube_stateful_set/overview)
...
Additionally, we provide a submodule, [kube\_service](/docs/main/modules/kube_service/overview),
...
We provide a submodule, [kube\_ingress](/docs/main/modules/kube_ingress/overview),
...
In addition, we provide a submodule [kube\_aws\_cdn](/docs/main/modules/kube_aws_cdn/overview),
