...
| AWS                  | [kube\_sa\_auth\_aws](/main/reference/infrastructure-modules/submodule/kubernetes/kube_sa_auth_aws)           | Sets up [IAM roles for service accounts (IRSA)](https://docs.aws.amazon.com/eks/latest/userguide/iam-roles-for-service-accounts.html) |
| Vault                | [kube\_sa\_auth\_vault](/main/reference/infrastructure-modules/submodule/kubernetes/kube_sa_auth_vault)       | Sets up the [Kubernetes auth method with Hashicorp Vault](https://developer.hashicorp.com/vault/docs/auth/kubernetes)                 |
| Argo                 | [kube\_sa\_auth\_workflow](/main/reference/infrastructure-modules/submodule/kubernetes/kube_sa_auth_workflow) | Provides the necessary permissions for the service account to be used in an Argo workflow pod                                         |
