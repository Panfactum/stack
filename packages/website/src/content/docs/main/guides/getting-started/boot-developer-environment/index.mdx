...
* shared: Set up in the repo's `panfactum.yaml` by your organization's administrators ([docs](/main/reference/configuration/repo-variables))
* personal: Unique to you and set up in a top-level `.env` file ([docs](/main/reference/configuration/dotenv))
...
For the complete list of values, see the Panfactum [reference docs](/main/reference/configuration/dotenv).
