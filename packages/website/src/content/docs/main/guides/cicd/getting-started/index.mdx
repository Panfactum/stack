...
* This guide requires that you have installed the [Workflow Engine Stack Addon.](/main/guides/addons/workflow-engine/installing)

* Setting up your CI / CD integrations will require writing new IaC modules. Ensure you understand the
  basic concepts for this by reviewing [our first-party IaC guide](/main/guides/iac/first-party-modules).
...
<MarkdownAlert severity="info">
  ...
  we do offer alternative modules for [self-hosted GitHub Actions](/main/guides/addons/github-actions/installing). However,
  unlike Argo Workflows, we do not provide robust support beyond the foundational components.
</MarkdownAlert>

We will be deploying our [recommended CI / CD architecture](/main/concepts/cicd/recommended-architecture). Please
...
2. Add a new Kubernetes namespace using our
   [kube\_namespace](/main/reference/infrastructure-modules/submodule/kubernetes/kube_namespace) submodule.

3. Follow our [guide for creating a new Event Bus.](/main/guides/addons/event-bus/installing)
...
[wf\_tf\_deploy](/main/reference/infrastructure-modules/submodule/workflow/wf_tf_deploy),
...
[prebuilt workflows](/main/guides/addons/workflow-engine/prebuilt-workflows).
