...
We provide a complete example the IaC of a fully functional CI / CD system [here](https://github.com/Panfactum/reference-infrastructure/tree/__PANFACTUM_VERSION_MAIN__/infrastructure/demo_cicd).
