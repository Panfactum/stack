...
We provide GHA runner modules ([kube\_gha](/main/reference/infrastructure-modules/direct/kubernetes/kube_gha) and [kube\_gha\_runners](/main/reference/infrastructure-modules/direct/kubernetes/kube_gha_runners)) as a convenience so that you can leverage Panfactum to reduce costs and improve the speed
