...
The Panfactum Stack's Cilium deployment ([kube\_cilium](/docs/main/modules/kube_cilium/overview)) has a few enhancements over the default Cilium install:
...
You can see our implementation in the [kube\_linkerd](/docs/main/modules/kube_linkerd/overview) terraform module.
...
In the Panfactum Stack, we use the Ingress-NGINX Controller ([kube\_ingress\_nginx](/docs/main/modules/kube_ingress_nginx/overview))
...
We provide a submodule for defining Ingress manifests for our Ingress-NGINX controller: [kube\_ingress](/docs/main/modules/kube_ingress/overview).
...
In the Panfactum Stack, we provide the [kube\_external\_dns](/docs/main/modules/kube_external_dns/overview)
...
[kube\_bastion](/docs/main/modules/kube_bastion/overview).
...
Stack via [kube\_cert\_manager](/docs/main/modules/kube_cert_manager/overview).
...
[kube\_ingress](/docs/main/modules/kube_ingress/overview) submodule.
