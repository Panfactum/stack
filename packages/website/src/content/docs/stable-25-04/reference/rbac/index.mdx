...
These are the default groups provisioned by the [authentik\_core\_resources](/docs/stable-25-04/reference/infrastructure-modules/direct/authentik/authentik_core_resources). **These
are global.**
