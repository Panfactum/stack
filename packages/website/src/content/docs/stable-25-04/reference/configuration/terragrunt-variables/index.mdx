...
Your environments folder at `environments_dir` **must** have three levels of scoping for the [configuration-as-code](/stable-25-04/concepts/iac#configuration-as-code):
...
*To apply modules that use the Authentik provider, you will also need to have `AUTHENTIK_TOKEN` set in [your .env file.](/stable-25-04/reference/configuration/dotenv)*