...
<ModuleHeader name="kube_vpa" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_vpa" status="stable" type="direct"/>
...
- Ensure you have deployed [kube\_monitoring](/docs/stable-25-04/reference/infrastructure-modules/kubernetes/kube\_monitoring).
