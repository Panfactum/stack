...
<ModuleHeader
  name="aws_kms_encrypt_key"
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/aws_kms_encrypt_key"
  status="stable"
  type="submodule"
/>
...
1. The keys provisioned by this module must be manually deleted as deletion prevention in terraform is enabled.

2. This is a multi-region module so it requires the secondary aws provider to be enabled. This is to keep everything in
   sync.
