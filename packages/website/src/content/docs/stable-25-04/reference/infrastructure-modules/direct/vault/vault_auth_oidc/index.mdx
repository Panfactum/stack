...
<ModuleHeader
  ...
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/vault_auth_oidc"
  status="stable"
  type="direct"
/>
...
To be used with the
[authentik_vault_sso](/docs/stable-25-04/reference/infrastructure-modules/authentik/authentik_vault_sso) module.
