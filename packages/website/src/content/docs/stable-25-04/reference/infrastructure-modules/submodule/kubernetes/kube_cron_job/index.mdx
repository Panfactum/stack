...
<ModuleHeader
  name="kube_cron_job"
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_cron_job"
  status="stable"
  type="submodule"
/>
...
[CronJob](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/) with the following enhancements:
...
This module's has inputs that map one-for-one to the
[standard Kubernetes CronJob API.](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.29/#cronjobspec-v1-batch)
