...
<ModuleHeader name="kube_reloader" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_reloader" status="stable" type="direct"/>
