...
<ModuleHeader
  name="kube_vault"
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_vault"
  status="stable"
  type="direct"
/>
...
This module deploys [Hashicorp Vault](https://www.vaultproject.io/) to the cluster via the
