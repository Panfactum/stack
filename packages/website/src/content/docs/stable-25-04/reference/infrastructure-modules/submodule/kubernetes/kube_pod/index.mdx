...
<ModuleHeader
  name="kube_pod"
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_pod"
  status="stable"
  type="submodule"
/>
...
This module does **not** create a Kubernetes Pod but rather exposes a `pod_template` output that is intended to by used
by higher-level controllers such as Deployments and StatefulSets. This module is used internally by many Panfactum
submodules such as
[kube_deployment](/docs/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_deployment) and
[kube_stateful_set](/docs/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_stateful_set).

## Usage

This module follows most of the conventions outlined in
...
Description: True iff a set of default permissions should be granted to the Pod's service account (e.g., reading its own
manifest).
...
Description: A mapping of volume names to their mount configuration in the containers of the Pod. Used for dynamically
generated Volumes such as in StatefulSets.
