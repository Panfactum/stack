...
<ModuleHeader name="kube_redis_sentinel" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_redis_sentinel" status="stable" type="submodule"/>
...
environment variables in our [kube\_deployment](/docs/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube\_deployment) module.
...
(provided by [kube\_pvc\_autoresizer](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube\_pvc\_autoresizer))
...
[kube\_disruption\_window\_controller](/docs/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube\_disruption\_window\_controller)
submodule.
