...
<ModuleHeader
  name="kube_argo_event_bus"
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_argo_event_bus"
  status="beta"
  type="submodule"
/>
...
Deploys an [EventBus](https://argoproj.github.io/argo-events/concepts/eventbus/) resource as a part of the
[Argo Events architecture](https://argoproj.github.io/argo-events/concepts/architecture/).

The EventBus is a set of [NATS](https://nats.io/) nodes that temporarily store inbound events from
[EventSources](https://argoproj.github.io/argo-events/concepts/event_source/) before distributing them via
[Sensors](https://argoproj.github.io/argo-events/concepts/sensor/).
