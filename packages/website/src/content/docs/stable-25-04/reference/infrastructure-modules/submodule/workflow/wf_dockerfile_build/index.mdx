...
<MarkdownAlert severity="warning">
  This module will only run inside of clusters that have the [kube\_buildkit](/stable-25-04/guides/addons/buildkit/installing) addon deployed.
</MarkdownAlert>
...
* Check out the source code indicated by `code_repo` using our [standard checkout process](/stable-25-04/guides/cicd/checking-out-code).
...
<MarkdownAlert severity="info">
  Make sure you review [our guide](/stable-25-04/guides/addons/buildkit/building-images) on how to optimize your Dockerfiles and build processes.
</MarkdownAlert>

### Authenticating with Private Code Repositories

`git_username` and `git_password` can be used for authenticating with a private `code_repo`. See our [documentation](/stable-25-04/guides/cicd/checking-out-code)
...
will need to adjust the parameters of the [kube\_buildkit](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_buildkit) module.
