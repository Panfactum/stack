...
<ModuleHeader name="kube_metrics_server" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_metrics_server" status="stable" type="direct"/>
