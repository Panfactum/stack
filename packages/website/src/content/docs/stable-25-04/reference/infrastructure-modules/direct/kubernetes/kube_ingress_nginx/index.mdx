...
<ModuleHeader name="kube_ingress_nginx" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_ingress_nginx" status="stable" type="direct" />
