...
<ModuleHeader name="kube_karpenter" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_karpenter" status="stable" type="direct" />
