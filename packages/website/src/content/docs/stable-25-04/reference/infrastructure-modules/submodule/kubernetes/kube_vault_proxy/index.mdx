...
This module is intended to be used in conjunction with the [kube\_ingress](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_ingress)
