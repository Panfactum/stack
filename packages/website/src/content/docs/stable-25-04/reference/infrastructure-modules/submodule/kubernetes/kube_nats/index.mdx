...
<ModuleHeader name="kube_nats" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_nats" status="beta" type="submodule"/>
...
in our [kube\_deployment](/docs/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube\_deployment) module.
