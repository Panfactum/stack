...
<ModuleHeader
  ...
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_monitoring"
  status="alpha"
  type="direct"
/>
...
[kube-prometheus-stack](https://github.com/prometheus-community/helm-charts/tree/main/charts/kube-prometheus-stack). It
includes:
...
Description: Number of GB for the ephemeral thanos compactor disk. See
[https://thanos.io/tip/components/compact.md/#disk](https://thanos.io/tip/components/compact.md/#disk)
