...
<ModuleHeader
  name="aws_ecr_public_repos"
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/aws_ecr_public_repos"
  status="stable"
  type="direct"
/>
...
[custom alias](https://docs.aws.amazon.com/AmazonECR/latest/public/public-registry-settings.html). This may take a few
days to be approved.
