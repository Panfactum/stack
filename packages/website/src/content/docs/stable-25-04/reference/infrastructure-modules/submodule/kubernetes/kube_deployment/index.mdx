...
<ModuleHeader name="kube_deployment" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_deployment" status="stable" type="submodule" />
...
This module follows the basic workload deployment patterns describe in [this guide](/stable-25-04/guides/deploying-workloads/basics).
...
Description: Whether to enable topology spread constraints to spread pods across availability zones (with ScheduleAnyways). Defaults to true iff sla\_target >= 2.
