...
<ModuleHeader
  ...
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_deployment"
  status="stable"
  type="submodule"
/>
...
[Deployment](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/) with the following enhancements:
...
ScheduleAnyways). Defaults to true iff sla_target >= 2.
...
Description: If provided, the Deployment's service will be statically bound to this IP address. Must be within the
