...
* Check out the source code indicated by `repo` using our [standard process](/stable-25-04/guides/cicd/checking-out-code).
...
`git_username` and `git_password` can be used for authenticating with a private `repo`. See our [documentation](/stable-25-04/guides/cicd/checking-out-code)
