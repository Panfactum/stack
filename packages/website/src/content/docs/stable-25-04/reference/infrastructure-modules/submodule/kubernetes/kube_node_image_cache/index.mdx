...
<ModuleHeader name="kube_node_image_cache" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_node_image_cache" status="stable" type="submodule"/>
...
The [kube\_node\_image\_cache\_controller](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube\_node\_image\_cache\_controller) must be installed in order for this to work.

## Debugging

See [`kube_node_image_cache_controller` debugging docs.](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube\_node\_image\_cache\_controller#debugging)
