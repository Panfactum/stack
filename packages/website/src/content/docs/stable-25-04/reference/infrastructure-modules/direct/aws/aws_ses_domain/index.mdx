...
<ModuleHeader name="aws_ses_domain" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/aws_ses_domain" status="stable" type="direct" />
