...
<ModuleHeader name="aws_s3_private_bucket" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/aws_s3_private_bucket" status="stable" type="submodule" />
