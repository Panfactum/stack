...
<ModuleHeader name="authentik_github_sso" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/authentik_github_sso" status="stable" type="direct" />
...
1. Log in to GitHub and navigate to your enterprise's dashboard. For example, Panfactum's enterprise url is [https://github.com/enterprises/Panfactum](https://github.com/enterprises/Panfactum).
...
Description: The SAML metadata for the GitHub provider. [https://en.wikipedia.org/wiki/SAML\_metadata](https://en.wikipedia.org/wiki/SAML_metadata)
