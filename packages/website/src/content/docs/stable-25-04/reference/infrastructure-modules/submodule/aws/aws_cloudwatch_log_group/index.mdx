...
<ModuleHeader name="aws_cloudwatch_log_group" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/aws_cloudwatch_log_group" status="stable" type="submodule" />
