...
Please follow the steps defined in the [MongoDB Atlas Identity Provider](/stable-25-04/reference/infrastructure-modules/direct/authentik/mongodb_atlas_identity_provider) and resume here.
