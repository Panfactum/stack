...
<ModuleHeader
  ...
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/authentik_core_resources"
  status="stable"
  type="direct"
/>
...
Description: The session duration for user logins. See
[https://docs.goauthentik.io/docs/flow/stages/user_login/](https://docs.goauthentik.io/docs/flow/stages/user_login/)
