...
<ModuleHeader name="authentik_core_resources" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/authentik_core_resources" status="stable" type="direct" />
