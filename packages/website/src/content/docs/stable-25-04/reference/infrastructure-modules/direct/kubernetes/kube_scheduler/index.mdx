...
<ModuleHeader name="kube_scheduler" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_scheduler" status="stable" type="direct"/>
