...
with the Panfactum deployment of Argo Workflows (deployed via [kube\_argo](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_argo))
...
For a basic introduction of how to use this module, see our [guide on creating Workflows](/stable-25-04/guides/addons/workflow-engine/creating-workflows).
...
as described [here](/stable-25-04/guides/addons/workflow-engine/triggering-workflows#from-other-workflows). This ensures
...
[kube\_constants](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_constants) submodule. The below code
...
[here](/stable-25-04/guides/addons/workflow-engine/triggering-workflows#from-other-workflows).
