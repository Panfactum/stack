...
with the Panfactum deployment of Argo Workflows (deployed via [kube\_argo](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube\_argo))
...
[kube\_constants](/docs/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube\_constants) submodule. The below code
