...
<ModuleHeader name="kube_kyverno" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_kyverno" status="stable" type="direct" />

# Kyverno

See our [bootstrapping guide documentation](/docs/stable-25-04/guides/bootstrapping/policy-controller) for installing [Kyverno](https://kyverno.io/docs/introduction/).
