...
See our [bootstrapping guide documentation](/stable-25-04/guides/bootstrapping/policy-controller) for installing [Kyverno](https://kyverno.io/docs/introduction/).
