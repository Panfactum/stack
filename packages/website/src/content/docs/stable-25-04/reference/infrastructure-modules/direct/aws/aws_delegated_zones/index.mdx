...
<ModuleHeader name="aws_delegated_zones" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/aws_delegated_zones" status="stable" type="direct" />
