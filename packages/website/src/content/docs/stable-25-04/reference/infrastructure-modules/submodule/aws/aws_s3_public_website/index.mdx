...
* `aws_cdn` ([docs](/stable-25-04/reference/infrastructure-modules/submodule/aws/aws_cdn)); or
* `aws_s3_private_bucket` ([docs](/stable-25-04/reference/infrastructure-modules/submodule/aws/aws_s3_private_bucket))
