...
<ModuleHeader name="aws_s3_public_website" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/aws_s3_public_website" status="beta" type="submodule"/>
...
- `aws_cdn` ([docs](/docs/stable-25-04/reference/infrastructure-modules/submodule/aws/aws\_cdn)); or
- `aws_s3_private_bucket` ([docs](/docs/stable-25-04/reference/infrastructure-modules/submodule/aws/aws\_s3\_private\_bucket))
