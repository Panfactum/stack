...
[^5]: For more information on SLA levels, see this [guide](/stable-25-04/guides/deploying-workloads/high-availability).
...
<MarkdownAlert severity="warning">
  You need *at least* one of each [subnet type](/stable-25-04/concepts/networking/aws-primitives) in at least three availability zones
...
If you are unfamiliar with NAT, you should review the [NAT concept documentation](/stable-25-04/concepts/networking/nat).
