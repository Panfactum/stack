...
<ModuleHeader name="authentik_aws_sso" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/authentik_aws_sso" status="stable" type="direct"/>
