...
If you have CICD setup and are deploying infrastructure using the [wf\_tf\_deploy](/docs/stable-25-04/reference/infrastructure-modules/submodule/workflow/wf\_tf\_deploy) module,
...
the [Sync Authentik with the Atlas Settings](/docs/stable-25-04/reference/infrastructure-modules/direct/authentik/authentik\_mongodb\_atlas\_sso)
section.
