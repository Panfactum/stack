...
<ModuleHeader name="mongodb_atlas_identity_provider" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/mongodb_atlas_identity_provider" status="beta" type="direct" />
...
If you have CICD setup and are deploying infrastructure using the [wf\_tf\_deploy](/docs/stable-25-04/reference/infrastructure-modules/submodule/workflow/wf_tf_deploy) module,
...
the [Sync Authentik with the Atlas Settings](/docs/stable-25-04/reference/infrastructure-modules/direct/authentik/authentik_mongodb_atlas_sso)
section.
