...
If you have CICD setup and are deploying infrastructure using the [wf\_tf\_deploy](/stable-25-04/reference/infrastructure-modules/submodule/workflow/wf_tf_deploy) module,
...
the [Sync Authentik with the Atlas Settings](/stable-25-04/reference/infrastructure-modules/direct/authentik/authentik_mongodb_atlas_sso)
section.
