...
<ModuleHeader
  name="aws_ecr_repos"
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/aws_ecr_repos"
  status="stable"
  type="direct"
/>
...
We provide this automatically for Kubernetes clusters deployed with the
[aws_eks](/docs/stable-25-04/reference/infrastructure-modules/direct/aws/aws_eks) module.
...
You might want to periodically remove outdated or unused images to save on storage costs. We provide three means to do
so:
