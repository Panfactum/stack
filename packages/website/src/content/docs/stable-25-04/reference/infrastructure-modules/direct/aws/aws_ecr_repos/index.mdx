...
We cover this in the [BuildKit guide](/stable-25-04/guides/addons/buildkit/installing).
...
We provide this automatically for Kubernetes clusters deployed with the [aws\_eks](/stable-25-04/reference/infrastructure-modules/direct/aws/aws_eks)
module.
