...
You can add arbitrary extra tags to the resources you deploy. See [this guide](/docs/stable-25-04/guides/iac/deploying-modules#resource-tagging) for instructions.
