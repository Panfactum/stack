...
[^1]:
    ...
    [bootstrapping guide.](/docs/stable-25-04/guides/bootstrapping/identity-provider)

If your organization's administrators have not already
[provisioned your account](/docs/stable-25-04/guides/user-management/provisioning-new-user), ask them now. You will need
to follow [this guide](/docs/stable-25-04/guides/user-management/setting-up-new-user) to set up your user for the first
time.
...
2. Update the `config.user.yaml` to include the clusters you want to access and what AWS profile you want to use for
   that access. See the [reference docs](/docs/stable-25-04/reference/configuration/kubernetes#config.user.yaml) for the
   specific syntax.
...
<MarkdownGuideNav
  backHref={"/docs/stable-25-04/guides/getting-started/boot-developer-environment"}
  stepNumber={4}
  totalSteps={4}
