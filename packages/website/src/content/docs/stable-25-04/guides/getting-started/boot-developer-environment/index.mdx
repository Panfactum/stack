...
* shared: Set up in the repo's `panfactum.yaml` by your organization's administrators ([docs](/docs/stable-25-04/reference/configuration/repo-variables))
* personal: Unique to you and set up in a top-level `.env` file ([docs](/docs/stable-25-04/reference/configuration/dotenv))
...
<MarkdownGuideNav backHref={"/docs/stable-25-04/guides/getting-started/install-tooling"} forwardHref={"/docs/stable-25-04/guides/getting-started/connect-to-infrastructure"} stepNumber={3} totalSteps={4} progressLabel={"Getting Started Guide:"} />
