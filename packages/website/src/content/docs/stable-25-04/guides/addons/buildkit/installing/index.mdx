...
We provide a module, [kube\_buildkit](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_buildkit), for
...
We provide a module for configuring ECR with your image repositories: [aws\_ecr\_repos](/docs/stable-25-04/reference/infrastructure-modules/direct/aws/aws_ecr_repos). [^2]
...
[^2]: We also supply [aws\_ecr\_public\_repos](/docs/stable-25-04/reference/infrastructure-modules/direct/aws/aws_ecr_public_repos) for deploying
