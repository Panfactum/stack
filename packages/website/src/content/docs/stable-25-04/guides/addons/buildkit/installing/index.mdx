...
[^3]: A more detailed architectural overview can be found [here](/stable-25-04/concepts/buildkit).
...
We provide a module, [kube\_buildkit](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_buildkit), for
...
We provide a module for configuring ECR with your image repositories: [aws\_ecr\_repos](/stable-25-04/reference/infrastructure-modules/direct/aws/aws_ecr_repos). [^2]
...
[^2]: We also supply [aws\_ecr\_public\_repos](/stable-25-04/reference/infrastructure-modules/direct/aws/aws_ecr_public_repos) for deploying
...
([reference docs](/stable-25-04/reference/configuration/buildkit)).
...
* [Core techniques for building images](/stable-25-04/guides/addons/buildkit/building-images)
