...
[^1]: Argo Events can also be used to trigger many more actions than just Argo Workflows. See our
    [Event Bus Addon](/stable-25-04/guides/addons/event-bus/installing) guide.
...
We provide a module, [kube\_argo](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_argo), that
...
* To start creating your own custom Workflows, take a look at [our documentation](/stable-25-04/guides/addons/workflow-engine/creating-workflows).

* Deploy some of [our pre-built Workflows](/stable-25-04/guides/addons/workflow-engine/prebuilt-workflows) for common tasks in the Panfactum Stack

* Learn how to use Workflows for your CI / CD system [here.](/stable-25-04/guides/cicd/getting-started)

* Learn more about how to leverage Argo Events [here.](/stable-25-04/guides/addons/event-bus/installing)
