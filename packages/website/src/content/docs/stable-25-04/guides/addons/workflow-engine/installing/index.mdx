...
Because you will often want these types of external triggers, we install both Argo Workflows *and* Argo Events in this
...
* To start creating your own custom Workflows, take a look at
  [our documentation](/docs/stable-25-04/guides/addons/workflow-engine/creating-workflows).

* Deploy some of [our pre-built Workflows](/docs/stable-25-04/guides/addons/workflow-engine/prebuilt-workflows) for
  common tasks in the Panfactum Stack
