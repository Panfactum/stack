...
Set the `iac_dir` repo variable to that directory per the [reference docs](/docs/stable-25-04/reference/configuration/repo-variables).
...
All the rules in the [main module deployment guide](/docs/stable-25-04/guides/iac/deploying-modules#defining-a-module-for-deployment) apply.
...
* Set the `repo_url` [repository variable](/docs/stable-25-04/reference/configuration/repo-variables). This will likely have already been set up when your system was first deployed.

* Set `GIT_USERNAME` and `GIT_PASSWORD` in your [personal `.env` file](/docs/stable-25-04/reference/configuration/dotenv). The values will be combined with `repo_url` to clone your IaC over HTTPS as follows:
...
<MarkdownAlert severity="info">
    ...
    by following [these instructions.](/docs/stable-25-04/reference/infrastructure-modules/submodule/workflow/wf_tf_deploy#authenticating-with-private-repositories)
</MarkdownAlert>
...
In addition to the infrastructure modules that you deploy directly, we provide [many submodules](/docs/stable-25-04/reference/infrastructure-modules/overview)
...
and `pf_module_ref`. Whenever you change the `pf_stack_version` [Terragrunt variable](/docs/stable-25-04/reference/configuration/terragrunt-variables#module-source), these variables will
...
<MarkdownAlert severity="info">
    ...
    by setting the `pf_stack_local_use_relative` [Terragrunt variable](/docs/stable-25-04/reference/configuration/terragrunt-variables#module-source) to `false`.
...
to **you**. For all available settings, see the [reference documentation.](/docs/stable-25-04/reference/configuration/terragrunt-variables)
