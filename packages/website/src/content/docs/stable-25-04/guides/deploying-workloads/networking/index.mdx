...
* [Overview guide for deploying workloads](/stable-25-04/guides/deploying-workloads/basics)
* [Kubernetes networking concept documentation](/stable-25-04/concepts/networking/cluster-networking)
...
* [kube\_deployment](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_deployment)
* [kube\_stateful\_set](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_stateful_set)
...
Additionally, we provide a submodule, [kube\_service](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_service),
...
more background information, see our [concept docs](/stable-25-04/concepts/networking/cluster-networking#inbound-networking).

The central ingress infrastructure is set up in the [bootstrapping guide](/stable-25-04/guides/bootstrapping/inbound-networking#deploy-the-ingress-system),
but you will still need to set up individual Ingress resources for each service that you want to expose
to the public internet.

We provide a submodule, [kube\_ingress](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_ingress),
...
In addition, we provide a submodule [kube\_aws\_cdn](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_aws_cdn),
...
which generates the mesh (see [concept docs](/stable-25-04/concepts/networking/cluster-networking#service-mesh)).
