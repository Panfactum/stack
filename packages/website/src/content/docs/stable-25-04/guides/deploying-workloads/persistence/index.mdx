...
use the [kube\_stateful\_set](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_stateful_set) module.
...
as a part of the [bootstrapping guide.](/stable-25-04/guides/bootstrapping/storage-interfaces)
...
[kube\_aws\_ebs\_csi](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_aws_ebs_csi) module.
