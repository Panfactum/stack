...
* This guide requires that you have installed the [Workflow Engine Stack Addon.](/stable-25-04/guides/addons/workflow-engine/installing)

* Setting up your CI / CD integrations will require writing new IaC modules. Ensure you understand the
  basic concepts for this by reviewing [our first-party IaC guide](/stable-25-04/guides/iac/first-party-modules).
...
<MarkdownAlert severity="info">
  ...
  we do offer alternative modules for [self-hosted GitHub Actions](/stable-25-04/guides/addons/github-actions/installing). However,
  unlike Argo Workflows, we do not provide robust support beyond the foundational components.
</MarkdownAlert>

We will be deploying our [recommended CI / CD architecture](/stable-25-04/concepts/cicd/recommended-architecture). Please
...
2. Add a new Kubernetes namespace using our
   [kube\_namespace](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_namespace) submodule.

3. Follow our [guide for creating a new Event Bus.](/stable-25-04/guides/addons/event-bus/installing)
...
[wf\_tf\_deploy](/stable-25-04/reference/infrastructure-modules/submodule/workflow/wf_tf_deploy),
...
[prebuilt workflows](/stable-25-04/guides/addons/workflow-engine/prebuilt-workflows).
