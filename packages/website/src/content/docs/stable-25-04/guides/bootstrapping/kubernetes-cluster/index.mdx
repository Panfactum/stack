...
using our [aws\_eks](/docs/stable-25-04/reference/infrastructure-modules/direct/aws/aws_eks) module.</p>
...
<MarkdownAlert severity="info">
  To save costs during the bootstrapping process you can follow the [Kubernetes Cluster Suspension Guide](/docs/stable-25-04/guides/bootstrapping/suspend-kubernetes-cluster)
...
We provide a module for configuring this behavior: [aws\_ecr\_pull\_through\_cache](/docs/stable-25-04/reference/infrastructure-modules/direct/aws/aws_ecr_pull_through_cache).
...
<MarkdownAlert severity="warning">
  *Every* one of your users will need to set up their own `config.user.yaml` file, and we provide instructions
  for them [here](/docs/stable-25-04/guides/getting-started/connect-to-infrastructure).
</MarkdownAlert>
...
some additional [terragrunt variables](/docs/stable-25-04/reference/configuration/terragrunt-variables).
