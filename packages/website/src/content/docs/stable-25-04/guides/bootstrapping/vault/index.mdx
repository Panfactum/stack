...
We will use the [kube\_vault](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_vault) infrastructure module to deploy
...
via the [vault\_core\_resources](/stable-25-04/reference/infrastructure-modules/direct/vault/vault_core_resources) module.
...
Let's now deploy [vault\_core\_resources](/stable-25-04/reference/infrastructure-modules/direct/vault/vault_core_resources):
...
in the [prior section](/stable-25-04/guides/bootstrapping/storage-interfaces).
