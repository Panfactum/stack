...
We will use the [kube\_vault](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_vault) infrastructure module to deploy
...
via the [vault\_core\_resources](/docs/stable-25-04/reference/infrastructure-modules/direct/vault/vault_core_resources) module.
...
Let's now deploy [vault\_core\_resources](/docs/stable-25-04/reference/infrastructure-modules/direct/vault/vault_core_resources):
...
in the [prior section](/docs/stable-25-04/guides/bootstrapping/storage-interfaces).
