...
We provide the [kube\_aws\_ebs\_csi](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_aws_ebs_csi) module to deploy the driver.
...
<BootstrappingGuideNav backHref={"/docs/stable-25-04/guides/bootstrapping/policy-controller"} forwardHref={"/docs/stable-25-04/guides/bootstrapping/vault"} stepNumber={11} />
