...
By default, this is the `main` branch. If you need to change it, make sure it is set as the `repo_primary_branch` (per the [docs](/docs/stable-25-04/reference/configuration/repo-variables)).
