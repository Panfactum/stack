...
Follow this [guide section](/docs/stable-25-04/guides/getting-started/install-tooling?bootstrapping=true) to install a few prerequisite tools.
...
For the full list of available values and their behavior, please refer to [these reference docs](/docs/stable-25-04/reference/configuration/repo-variables).
...
For the full list of Panfactum-specific environment variables, please refer to [these reference docs](/docs/stable-25-04/reference/configuration/dotenv).
...
<BootstrappingGuideNav backHref={"/docs/stable-25-04/guides/bootstrapping/overview"} forwardHref={"/docs/stable-25-04/guides/bootstrapping/preparing-aws"} stepNumber={2} />
