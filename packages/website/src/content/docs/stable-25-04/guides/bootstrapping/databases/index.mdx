...
We provide a module to deploy the operator: [kube\_cloudnative\_pg](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_cloudnative_pg).
...
We provide a module [kube\_pg\_cluster](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_pg_cluster) that you can use in your
projects to do this.
...
module called [test\_kube\_pg\_cluster](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_pg_cluster) which is a thin
wrapper around [kube\_pg\_cluster](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_pg_cluster).
...
3. You should eventually receive an output like the following:
   ...
   in [inbound networking section](/stable-25-04/guides/bootstrapping/inbound-networking).
...
* **Relational:** PostgreSQL ([kube\_pg\_cluster](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_pg_cluster))
* **Key-value:** Redis ([kube\_redis\_sentinel](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_redis_sentinel))
* **Message Broker:** NATS Jetstream ([kube\_nats](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_nats))
