...
[aws\_registered\_domains](/docs/stable-25-04/reference/infrastructure-modules/direct/aws/aws_registered_domains) module. [^1]
...
[^1]: The domains will have the following defaults you can override if desired:
    ...
    refer to the [module documentation](/docs/stable-25-04/reference/infrastructure-modules/direct/aws/aws_registered_domains).
...
This is accomplished via a concept called [subdomain delegation](/docs/stable-25-04/concepts/networking/subdomain-delegation). Panfactum's
[aws\_delegated\_zones](/docs/stable-25-04/reference/infrastructure-modules/direct/aws/aws_delegated_zones) will provide the relevant setup
for this to work.
...
3. Create a `terragrunt.hcl` in that directory that looks like this: [^4]
      ...
      ::: code-group labels=[global/aws_delegated_zones_production/terragrunt.hcl, global/aws_delegated_zones_development/terragrunt.hcl]
      ```hcl collapse={1-9} "REPLACE_ME"
      include "panfactum" {
         path   = find_in_parent_folders("panfactum.hcl")
         expose = true
...
4. Create a `module.yaml` in that directory:
      ...
      ::: code-group labels=[global/aws_delegated_zones_production/module.yaml, global/aws_delegated_zones_development/module.yaml]
...
If you have static records to deploy, you can use our [aws\_dns\_records](/docs/stable-25-04/reference/infrastructure-modules/direct/aws/aws_dns_records)
