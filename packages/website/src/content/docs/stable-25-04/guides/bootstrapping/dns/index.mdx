...
[aws\_registered\_domains](/stable-25-04/reference/infrastructure-modules/direct/aws/aws_registered_domains) module. [^1]
...
[^1]: The domains will have the following defaults you can override if desired:
    ...
    refer to the [module documentation](/stable-25-04/reference/infrastructure-modules/direct/aws/aws_registered_domains).
...
This is accomplished via a concept called [subdomain delegation](/stable-25-04/concepts/networking/subdomain-delegation). Panfactum's
[aws\_delegated\_zones](/stable-25-04/reference/infrastructure-modules/direct/aws/aws_delegated_zones) will provide the relevant setup
for this to work.
...
If you have static records to deploy, you can use our [aws\_dns\_records](/stable-25-04/reference/infrastructure-modules/direct/aws/aws_dns_records)
