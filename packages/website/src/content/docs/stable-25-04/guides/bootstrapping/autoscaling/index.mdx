...
and resource optimization, see our [concept docs.](/stable-25-04/concepts/autoscaling)
...
We provide a module to deploy the server: [kube\_metrics\_server](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_metrics_server).
...
We provide a module to deploy the VPA: [kube\_vpa](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_vpa).
...
We provide an infrastructure module to deploy it: [kube\_karpenter](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_karpenter).
...
the [kube\_karpenter\_node\_pools](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_karpenter_node_pools) module.
...
We provide an alternative scheduler in [kube\_scheduler](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_scheduler)
