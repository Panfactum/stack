...
check out our [concept documentation.](/docs/stable-25-04/concepts/networking/cluster-networking#service-mesh)

## Deploy Linkerd

[Linkerd](https://linkerd.io/2.15/overview/) is likely the most popular service mesh for Kubernetes,
and we provide a module for deploying it: [kube\_linkerd](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_linkerd)
