...
We provide a module to deploy this controller: [kube\_reloader](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_reloader).
...
While the pull-through image cache deployed in [earlier in this guide](/stable-25-04/guides/bootstrapping/kubernetes-cluster#configure-pull-through-cache)
...
Fortunately, we can provide a solution to this problem, the [kube_node_image_cache_controller](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_node_image_cache_controller).
...
via the  [kube_node_image_cache](/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_node_image_cache) submodule. This
is a *submodule* so you can use it many times inside [your own first-party infrastructure modules.](/stable-25-04/guides/iac/first-party-modules)
...
We provide a module to deploy it: [kube\_pvc\_autoresizer](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_pvc_autoresizer).
...
We provide a module for the Descheduler: [kube\_descheduler](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_descheduler).
...
via the [kube\_aws\_ebs\_csi](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_aws_ebs_csi) module we installed in
[a prior section](/stable-25-04/guides/bootstrapping/storage-interfaces).
...
We provide a module to deploy the external-snapshotter: [kube\_external\_snapshotter](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_external_snapshotter).
...
We provide a module to deploy this functionality: [kube\_velero](/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_velero).
