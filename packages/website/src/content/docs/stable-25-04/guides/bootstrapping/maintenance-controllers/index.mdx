...
We provide a module to deploy this controller: [kube\_reloader](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_reloader).
...
While the pull-through image cache deployed in [earlier in this guide](/docs/stable-25-04/guides/bootstrapping/kubernetes-cluster#configure-pull-through-cache)
...
Fortunately, we can provide a solution to this problem, the [kube_node_image_cache_controller](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_node_image_cache_controller).
...
via the  [kube_node_image_cache](/docs/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube_node_image_cache) submodule. This
is a *submodule* so you can use it many times inside [your own first-party infrastructure modules.](/docs/stable-25-04/guides/iac/first-party-modules)
...
2. Add a `terragrunt.hcl` to that directory that looks like this:
      ...
      ::: code-group labels=[kube_node_image_cache_controller/terragrunt.hcl]
      ```hcl collapse={1-14} "REPLACE_ME"
      include "panfactum" {
         path   = find_in_parent_folders("panfactum.hcl")
         expose = true
...
We provide a module to deploy it: [kube\_pvc\_autoresizer](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_pvc_autoresizer).
...
We provide a module for the Descheduler: [kube\_descheduler](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_descheduler).
...
via the [kube\_aws\_ebs\_csi](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_aws_ebs_csi) module we installed in
[a prior section](/docs/stable-25-04/guides/bootstrapping/storage-interfaces).
...
We provide a module to deploy the external-snapshotter: [kube\_external\_snapshotter](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_external_snapshotter).
...
We provide a module to deploy this functionality: [kube\_velero](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_velero).
