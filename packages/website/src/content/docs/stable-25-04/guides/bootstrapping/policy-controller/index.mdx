...
* Native integration with the [pull through cache](/docs/stable-25-04/guides/bootstrapping/kubernetes-cluster#configure-pull-through-cache)
...
We provide a module for deploying Kyverno, [kube\_kyverno](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_kyverno).
...
[Kyverno Policies](https://kyverno.io/docs/kyverno-policies/), we provide a module called [kube\_policies](/docs/stable-25-04/reference/infrastructure-modules/direct/kubernetes/kube_kyverno).
