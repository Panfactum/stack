...
We provide this automatically for Kubernetes clusters deployed with the [aws\_eks](/docs/stable-25-04/reference/infrastructure-modules/direct/aws/aws\_eks)
module.
