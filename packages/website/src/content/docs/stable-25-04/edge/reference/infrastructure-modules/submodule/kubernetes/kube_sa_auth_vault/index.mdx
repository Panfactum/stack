...
assigned in the [aws\_vpc](/docs/stable-25-04/reference/infrastructure-modules/aws/aws\_vpc) and [aws\_eks](/docs/stable-25-04/reference/infrastructure-modules/aws/aws\_eks)
