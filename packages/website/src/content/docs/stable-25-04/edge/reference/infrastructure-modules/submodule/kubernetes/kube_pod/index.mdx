...
[kube\_deployment](/docs/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube\_deployment) and [kube\_stateful\_set](/docs/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube\_stateful\_set).

## Usage

This module follows most of the conventions outlined in [this guide](/docs/stable-25-04/guides/deploying-workloads/basics).
