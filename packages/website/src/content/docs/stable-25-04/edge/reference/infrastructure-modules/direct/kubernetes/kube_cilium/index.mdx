...
<ModuleHeader name="kube_cilium" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_cilium" status="stable" type="direct"/>
