...
<ModuleHeader name="kube_node_image_cache_controller" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_STABLE_25_04__/packages/infrastructure/kube_node_image_cache_controller" status="stable" type="direct"/>
...
images to the cache by leveraging the [kube\_node\_image\_cache](/docs/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube\_node\_image\_cache) submodule.
