...
This module is intended to be used in conjunction with the [kube\_ingress](/docs/stable-25-04/reference/infrastructure-modules/submodule/kubernetes/kube\_ingress)
