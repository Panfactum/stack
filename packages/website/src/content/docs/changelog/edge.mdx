...
* Provides the capability to configure many JetStream Stream settings in [kube_argo_event_bus](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_argo_event_bus).
...
* Event streams in [kube_argo_event_bus](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_argo_event_bus) are now properly replicated across all NATS servers.
