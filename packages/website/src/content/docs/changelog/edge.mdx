...
* Resolves issue in [kube_argo](/docs/edge/reference/infrastructure-modules/submodule/kubernetes/kube_argo) that prevented resources controlled by Argo Events from being updated without a controller restart.
