...
* Adds [authentik_github_sso](/docs/main/reference/infrastructure-modules/direct/authentik/authentik_github_sso) module for setting up the Authentik Application and Provider for Github.
