...
output from instances of the [kube\_ingress](/edge/reference/infrastructure-modules/submodule/kubernetes/kube_ingress)
module and forwarding them to the [aws\_cdn](/edge/reference/infrastructure-modules/submodule/aws/aws_cdn) module.

This module takes the same arguments as `aws_cdn`, so see it's [module documentation](/edge/reference/infrastructure-modules/submodule/aws/aws_cdn)
...
* For additional limitations, see the [aws\_cdn](/edge/reference/infrastructure-modules/submodule/aws/aws_cdn) module docs.
