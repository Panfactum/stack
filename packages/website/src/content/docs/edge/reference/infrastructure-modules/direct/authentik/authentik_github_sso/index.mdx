...
<ModuleHeader name="authentik_github_sso" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/authentik_github_sso" status="stable" type="direct" />
