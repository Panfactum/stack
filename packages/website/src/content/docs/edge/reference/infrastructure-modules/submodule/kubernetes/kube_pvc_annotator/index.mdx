...
<ModuleHeader name="kube_pvc_annotator" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_pvc_annotator" status="stable" type="submodule"/>
...
[kube\_stateful\_set](/docs/edge/reference/infrastructure-modules/submodule/kubernetes/kube\_stateful\_set).
