...
no other security controls are applied (unlike [kube\_sa\_auth\_aws](/edge/reference/infrastructure-modules/submodule/kubernetes/kube_sa_auth_aws)).

<MarkdownAlert severity="warning">
  This module should *only* be used when [kube\_sa\_auth\_aws](/edge/reference/infrastructure-modules/submodule/kubernetes/kube_sa_auth_aws)
