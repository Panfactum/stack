...
<ModuleHeader name="kube_certificates" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_certificates" status="stable" type="direct" />
