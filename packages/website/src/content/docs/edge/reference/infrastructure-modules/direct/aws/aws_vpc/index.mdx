...
[^5]: For more information on SLA levels, see this [guide](/edge/guides/deploying-workloads/high-availability).
...
<MarkdownAlert severity="warning">
  You need *at least* one of each [subnet type](/edge/concepts/networking/aws-primitives) in at least three availability zones
...
If you are unfamiliar with NAT, you should review the [NAT concept documentation](/edge/concepts/networking/nat).
