...
The [kube\_node\_image\_cache\_controller](/edge/reference/infrastructure-modules/direct/kubernetes/kube_node_image_cache_controller) must be installed in order for this to work.

## Debugging

See [`kube_node_image_cache_controller` debugging docs.](/edge/reference/infrastructure-modules/direct/kubernetes/kube_node_image_cache_controller#debugging)
