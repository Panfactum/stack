...
We cover this in the [BuildKit guide](/edge/guides/addons/buildkit/installing).
...
We provide this automatically for Kubernetes clusters deployed with the [aws\_eks](/edge/reference/infrastructure-modules/direct/aws/aws_eks)
module.
