...
[kube\_deployment](/edge/reference/infrastructure-modules/submodule/kubernetes/kube_deployment) and [kube\_stateful\_set](/edge/reference/infrastructure-modules/submodule/kubernetes/kube_stateful_set).

## Usage

This module follows most of the conventions outlined in [this guide](/edge/guides/deploying-workloads/basics).
