...
Please follow the steps defined in the [MongoDB Atlas Identity Provider](/edge/reference/infrastructure-modules/direct/authentik/mongodb_atlas_identity_provider) and resume here.
