...
<ModuleHeader name="authentik_mongodb_atlas_sso" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/authentik_mongodb_atlas_sso" status="beta" type="direct"/>
...
Please follow the steps defined in the [MongoDB Atlas Identity Provider](/docs/edge/reference/infrastructure-modules/direct/authentik/mongodb\_atlas\_identity\_provider) and resume here.
