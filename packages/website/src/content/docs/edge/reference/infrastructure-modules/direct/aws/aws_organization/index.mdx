...
<ModuleHeader name="aws_organization" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/aws_organization" status="stable" type="direct" />
