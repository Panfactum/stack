...
with the Panfactum deployment of Argo Workflows (deployed via [kube\_argo](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube\_argo))
...
[kube\_constants](/docs/edge/reference/infrastructure-modules/submodule/kubernetes/kube\_constants) submodule. The below code
