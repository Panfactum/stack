...
with the Panfactum deployment of Argo Workflows (deployed via [kube\_argo](/edge/reference/infrastructure-modules/direct/kubernetes/kube_argo))
...
For a basic introduction of how to use this module, see our [guide on creating Workflows](/edge/guides/addons/workflow-engine/creating-workflows).
...
as described [here](/edge/guides/addons/workflow-engine/triggering-workflows#from-other-workflows). This ensures
...
[kube\_constants](/edge/reference/infrastructure-modules/submodule/kubernetes/kube_constants) submodule. The below code
...
[here](/edge/guides/addons/workflow-engine/triggering-workflows#from-other-workflows).
