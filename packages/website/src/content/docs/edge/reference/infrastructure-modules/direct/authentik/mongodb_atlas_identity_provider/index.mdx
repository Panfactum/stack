...
If you have CICD setup and are deploying infrastructure using the [wf\_tf\_deploy](/docs/edge/reference/infrastructure-modules/submodule/workflow/wf_tf_deploy) module,
...
the [Sync Authentik with the Atlas Settings](/docs/edge/reference/infrastructure-modules/direct/authentik/authentik_mongodb_atlas_sso)
section.
