...
If you have CICD setup and are deploying infrastructure using the [wf\_tf\_deploy](/edge/reference/infrastructure-modules/submodule/workflow/wf_tf_deploy) module,
...
the [Sync Authentik with the Atlas Settings](/edge/reference/infrastructure-modules/direct/authentik/authentik_mongodb_atlas_sso)
section.
