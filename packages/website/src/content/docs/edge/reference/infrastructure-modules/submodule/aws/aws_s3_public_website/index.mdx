...
* `aws_cdn` ([docs](/edge/reference/infrastructure-modules/submodule/aws/aws_cdn)); or
* `aws_s3_private_bucket` ([docs](/edge/reference/infrastructure-modules/submodule/aws/aws_s3_private_bucket))
