...
<ModuleHeader name="kube_deployment" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_deployment" status="stable" type="submodule" />
...
This module follows the basic workload deployment patterns describe in [this guide](/edge/guides/deploying-workloads/basics).
