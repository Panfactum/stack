...
*To apply modules that use the Authentik provider, you will also need to have `AUTHENTIK_TOKEN` set in [your .env file.](/docs/edge/reference/configuration/dotenv)*