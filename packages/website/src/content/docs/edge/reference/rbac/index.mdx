...
These are the default groups provisioned by the [authentik\_core\_resources](/edge/reference/infrastructure-modules/direct/authentik/authentik_core_resources). **These
are global.**
