...
This guide assumes you are trying to pin to version `__PANFACTUM_VERSION_EDGE__`, and you should substitute this with
...
[terragrunt variable](/docs/edge/reference/configuration/terragrunt-variables).
