...
[^3]: A more detailed architectural overview can be found [here](/edge/concepts/buildkit).
...
We provide a module, [kube\_buildkit](/edge/reference/infrastructure-modules/direct/kubernetes/kube_buildkit), for
...
We provide a module for configuring ECR with your image repositories: [aws\_ecr\_repos](/edge/reference/infrastructure-modules/direct/aws/aws_ecr_repos). [^2]
...
[^2]: We also supply [aws\_ecr\_public\_repos](/edge/reference/infrastructure-modules/direct/aws/aws_ecr_public_repos) for deploying
...
([reference docs](/edge/reference/configuration/buildkit)).
...
* [Core techniques for building images](/edge/guides/addons/buildkit/building-images)
