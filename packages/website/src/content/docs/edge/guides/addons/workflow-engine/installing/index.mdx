...
We provide a module, [kube_argo](/docs/edge/modules/kube_argo/overview), that deploys the controllers for both Argo
...
- To start creating your own custom Workflows, take a look at
  [our documentation](/docs/edge/guides/addons/workflow-engine/creating-workflows).

- Deploy some of [our pre-built Workflows](/docs/edge/guides/addons/workflow-engine/prebuilt-workflows) for common tasks
