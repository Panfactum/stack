...
- Deploying the components of the Event Bus requires that the Argo Events controller is running. This is done via
  deploying the [Workflow Engine Stack Addon.](/docs/edge/guides/addons/workflow-engine/installing)

- Deploying an Event Bus requires writing your own IaC. Be sure you have reviewed
  [our guide on how to do this in the Panfactum stack.](/docs/edge/guides/iac/first-party-modules)
...
- [kube_argo_event_source](/docs/edge/modules/kube_argo_event_source/overview)

- [kube_argo_sensor](/docs/edge/modules/kube_argo_sensor/overview)

- [kube_argo_event_bus](/docs/edge/modules/kube_argo_event_bus/overview)
