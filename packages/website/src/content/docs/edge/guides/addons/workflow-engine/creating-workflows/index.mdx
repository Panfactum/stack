...
<p class="subtitle">Demonstrate how to use the [wf\_spec](/docs/edge/modules/wf_spec/overview)
...
[wf\_spec](/docs/edge/modules/wf_spec/overview), that aims to simplify the process
...
see the documentation for [wf\_spec](/docs/edge/modules/wf_spec/overview).
