...
<p class="subtitle">Demonstrate how to use the [wf\_spec](/edge/reference/infrastructure-modules/submodule/workflow/wf_spec)
...
* [Installing the Argo Workflow Engine](/edge/guides/addons/workflow-engine/installing)
* [Developing First-party IaC Modules](/edge/guides/iac/first-party-modules)
...
[wf\_spec](/edge/reference/infrastructure-modules/submodule/workflow/wf_spec), that aims to simplify the process
...
see the documentation for [wf\_spec](/edge/reference/infrastructure-modules/submodule/workflow/wf_spec).
...
[^4]: Running on `arm64` nodes will save about 20% of your workflow costs, so it might be worth it to create
    a multi-platform image. See our [guide.](/edge/guides/addons/buildkit/building-images)
...
* You provide many [prebuilt WorkflowTemplates](/edge/guides/addons/workflow-engine/prebuilt-workflows) that you can examine for best practices.
