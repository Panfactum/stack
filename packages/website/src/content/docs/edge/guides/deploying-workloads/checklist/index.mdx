...
* Do you have a networked workload? If so:
  ...
  * Do you need to allow public access? Have you set up an Ingress with [kube\_ingress](/docs/edge/reference/infrastructure-modules/submodule/kubernetes/kube_ingress)?
