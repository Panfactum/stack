...
* [kube\_deployment](/docs/edge/modules/kube_deployment/overview)
* [kube\_stateful\_set](/docs/edge/modules/kube_stateful_set/overview)
...
Additionally, we provide a submodule, [kube\_service](/docs/edge/modules/kube_service/overview),
...
We provide a submodule, [kube\_ingress](/docs/edge/modules/kube_ingress/overview),
...
In addition, we provide a submodule [kube\_aws\_cdn](/docs/edge/modules/kube_aws_cdn/overview),
