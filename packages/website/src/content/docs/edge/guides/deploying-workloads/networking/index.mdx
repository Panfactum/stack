...
* [Overview guide for deploying workloads](/edge/guides/deploying-workloads/basics)
* [Kubernetes networking concept documentation](/edge/concepts/networking/cluster-networking)
...
* [kube\_deployment](/edge/reference/infrastructure-modules/submodule/kubernetes/kube_deployment)
* [kube\_stateful\_set](/edge/reference/infrastructure-modules/submodule/kubernetes/kube_stateful_set)
...
Additionally, we provide a submodule, [kube\_service](/edge/reference/infrastructure-modules/submodule/kubernetes/kube_service),
...
more background information, see our [concept docs](/edge/concepts/networking/cluster-networking#inbound-networking).

The central ingress infrastructure is set up in the [bootstrapping guide](/edge/guides/bootstrapping/inbound-networking#deploy-the-ingress-system),
but you will still need to set up individual Ingress resources for each service that you want to expose
to the public internet.

We provide a submodule, [kube\_ingress](/edge/reference/infrastructure-modules/submodule/kubernetes/kube_ingress),
...
In addition, we provide a submodule [kube\_aws\_cdn](/edge/reference/infrastructure-modules/submodule/kubernetes/kube_aws_cdn),
...
which generates the mesh (see [concept docs](/edge/concepts/networking/cluster-networking#service-mesh)).
