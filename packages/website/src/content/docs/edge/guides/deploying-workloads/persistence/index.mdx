...
use the [kube\_stateful\_set](/edge/reference/infrastructure-modules/submodule/kubernetes/kube_stateful_set) module.
...
as a part of the [bootstrapping guide.](/edge/guides/bootstrapping/storage-interfaces)
...
[kube\_aws\_ebs\_csi](/edge/reference/infrastructure-modules/direct/kubernetes/kube_aws_ebs_csi) module.
