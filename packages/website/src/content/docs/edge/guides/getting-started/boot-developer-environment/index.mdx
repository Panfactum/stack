...
* shared: Set up in the repo's `panfactum.yaml` by your organization's administrators ([docs](/edge/reference/configuration/repo-variables))
* personal: Unique to you and set up in a top-level `.env` file ([docs](/edge/reference/configuration/dotenv))
...
For the complete list of values, see the Panfactum [reference docs](/edge/reference/configuration/dotenv).
