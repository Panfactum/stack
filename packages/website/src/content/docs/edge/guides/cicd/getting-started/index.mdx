...
<MarkdownAlert severity="info">
  ...
  we do offer alternative modules for [self-hosted GitHub Actions](/docs/edge/guides/addons/github-actions/installing). However,
...
2. Add a new Kubernetes namespace using our
   [kube\_namespace](/docs/edge/modules/kube_namespace/overview) submodule.
...
We provide [several prebuilt Workflows](/docs/edge/guides/addons/workflow-engine/prebuilt-workflows)
that you can use for common CI / CD tasks.

Right now, let's set up the IaC deployment workflow,
[wf\_tf\_deploy](/docs/edge/modules/wf_tf_deploy/overview),
