...
We will use the [kube_vault](/docs/edge/modules/kube_vault/overview) infrastructure module to deploy Vault in a highly
...
[vault_core_resources](/docs/edge/modules/vault_core_resources/overview) module.
...
Let's now deploy [vault_core_resources](/docs/edge/modules/vault_core_resources/overview):
...
[prior section](/docs/edge/guides/bootstrapping/storage-interfaces).
