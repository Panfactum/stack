...
We will use the [kube\_vault](/edge/reference/infrastructure-modules/direct/kubernetes/kube_vault) infrastructure module to deploy
...
via the [vault\_core\_resources](/edge/reference/infrastructure-modules/direct/vault/vault_core_resources) module.
...
Let's now deploy [vault\_core\_resources](/edge/reference/infrastructure-modules/direct/vault/vault_core_resources):
...
in the [prior section](/edge/guides/bootstrapping/storage-interfaces).
