...
<p class="subtitle">Install the basic Kubernetes cluster networking primitives via the [kube\_core\_dns](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_core_dns)
and [kube\_cilium](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_cilium) modules.</p>
