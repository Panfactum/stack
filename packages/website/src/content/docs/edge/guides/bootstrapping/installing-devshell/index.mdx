...
Follow this [guide section](/edge/guides/getting-started/install-tooling?bootstrapping=true) to install a few prerequisite tools.
...
For the full list of available values and their behavior, please refer to [these reference docs](/edge/reference/configuration/repo-variables).
...
For the full list of Panfactum-specific environment variables, please refer to [these reference docs](/edge/reference/configuration/dotenv).
