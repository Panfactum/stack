...
[concept documentation.](/docs/edge/concepts/networking/cluster-networking#service-mesh)

## Deploy Linkerd

[Linkerd](https://linkerd.io/2.15/overview/) is likely the most popular service mesh for Kubernetes, and we provide a
module for deploying it: [kube_linkerd](/docs/edge/modules/kube_linkerd/overview)
