...
check out our [concept documentation.](/edge/concepts/networking/cluster-networking#service-mesh)

## Deploy Linkerd

[Linkerd](https://linkerd.io/2.15/overview/) is likely the most popular service mesh for Kubernetes,
and we provide a module for deploying it: [kube\_linkerd](/edge/reference/infrastructure-modules/direct/kubernetes/kube_linkerd)
...
<BootstrappingGuideNav backHref={"/docs/edge/guides/bootstrapping/certificate-management"} forwardHref={"/docs/edge/guides/bootstrapping/autoscaling"} stepNumber={14} />
