...
[concept documentation](/docs/edge/concepts/networking/aws-primitives) before proceeding.
...
[SLA target level](/docs/edge/guides/deploying-workloads/high-availability#sla-levels) when deploying each environment.
...
[^91]:
    ...
    [the reference docs](/docs/edge/reference/configuration/terragrunt-variables#metadata).

## Create your VPC

We provide an [aws_vpc](/docs/edge/modules/aws_vpc/overview) module to deploy the VPC. This includes not only the VPC
...
We will now deploy the [aws_vpc](/docs/edge/modules/aws_vpc/overview) module via terragrunt:
...
<MarkdownAlert severity="warning">
  If you deviate from the default settings for the [aws\_vpc](/docs/edge/modules/aws_vpc/overview) module, you will need
