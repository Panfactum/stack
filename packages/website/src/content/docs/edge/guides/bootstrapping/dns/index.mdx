...
[aws\_registered\_domains](/edge/reference/infrastructure-modules/direct/aws/aws_registered_domains) module. [^1]
...
[^1]: The domains will have the following defaults you can override if desired:
    ...
    refer to the [module documentation](/edge/reference/infrastructure-modules/direct/aws/aws_registered_domains).
...
This is accomplished via a concept called [subdomain delegation](/edge/concepts/networking/subdomain-delegation). Panfactum's
[aws\_delegated\_zones](/edge/reference/infrastructure-modules/direct/aws/aws_delegated_zones) will provide the relevant setup
for this to work.
...
If you have static records to deploy, you can use our [aws\_dns\_records](/edge/reference/infrastructure-modules/direct/aws/aws_dns_records)
