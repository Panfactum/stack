...
[aws_registered_domains](/docs/edge/modules/aws_registered_domains/overview) module. [^1]
...
[^1]:
    ...
    refer to the [module documentation](/docs/edge/modules/aws_registered_domains/overview).
...
This is accomplished via a concept called [subdomain delegation](/docs/edge/concepts/background/networking/subdomain-delegation).
Panfactum's [aws_delegated_zones](/docs/edge/modules/aws_delegated_zones/overview) will provide the relevant setup for
this to work.
...
If you have static records to deploy, you can use our [aws_dns_records](/docs/edge/modules/aws_dns_records/overview)
