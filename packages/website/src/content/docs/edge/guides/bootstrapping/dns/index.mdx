...
[aws\_registered\_domains](/docs/edge/modules/aws_registered_domains/overview) module. [^1]
...
[aws\_delegated\_zones](/docs/edge/modules/aws_delegated_zones/overview) will provide the relevant setup
for this to work.
...
If you have static records to deploy, you can use our [aws\_dns\_records](/docs/edge/modules/aws_dns_records/overview)
