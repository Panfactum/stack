...
We provide both a module to deploy Authentik ([kube_authentik](/docs/edge/modules/kube_authentik/overview)) and many
...
We provide a module to do this: [aws_ses_domain](/docs/edge/modules/aws_ses_domain/overview).
...
7. (Optional) This module does not configure your DMARC record as you would typically only have one DMARC record that
   ...
   use the [aws_dns_records](/docs/edge/modules/aws_dns_records/overview) module to deploy the record.
...
[authentik_core_resources](/docs/edge/modules/authentik_core_resources/overview).
...
[Panfactum RBAC reference](/docs/edge/reference/rbac) for more information.
...
<BootstrappingGuideNav
  backHref={"/docs/edge/guides/bootstrapping/databases"}
  forwardHref={"/docs/edge/guides/bootstrapping/federated-auth"}
  stepNumber={19}
/>
