...
We provide a module to deploy this controller: [kube\_reloader](/docs/edge/modules/kube_reloader/overview).
...
We provide a module to deploy it: [kube\_pvc\_autoresizer](/docs/edge/modules/kube_pvc_autoresizer/overview).
...
We provide a module for the Descheduler: [kube\_descheduler](/docs/edge/modules/kube_descheduler/overview).
...
via the [kube\_aws\_ebs\_csi](/docs/edge/modules/kube_aws_ebs_csi/overview) module we installed in
...
We provide a module to deploy the external-snapshotter: [kube\_external\_snapshotter](/docs/edge/modules/kube_external_snapshotter/overview).
...
We provide a module to deploy this functionality: [kube\_velero](/docs/edge/modules/kube_velero/overview).
