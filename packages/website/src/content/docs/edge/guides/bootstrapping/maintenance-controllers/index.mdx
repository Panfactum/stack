...
Fortunately, we can provide a solution to this problem, the [kube\_node\_image\_cache\_controller](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_node_image_cache_controller).
...
[^22]: While many of our modules automatically specify images for the cache, you can specify additional images
    via the  [kube\_node\_image\_cache](/docs/edge/reference/infrastructure-modules/submodule/kubernetes/kube_node_image_cache) submodule. This
    is a *submodule* so you can use it many times inside [your own first-party infrastructure modules.](/docs/edge/guides/iac/first-party-modules)
