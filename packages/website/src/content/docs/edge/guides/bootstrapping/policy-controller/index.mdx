...
* Native integration with the [pull through cache](/edge/guides/bootstrapping/kubernetes-cluster#configure-pull-through-cache)
...
We provide a module for deploying Kyverno, [kube\_kyverno](/edge/reference/infrastructure-modules/direct/kubernetes/kube_kyverno).
...
[Kyverno Policies](https://kyverno.io/docs/kyverno-policies/), we provide a module called [kube\_policies](/edge/reference/infrastructure-modules/direct/kubernetes/kube_kyverno).
...
<BootstrappingGuideNav backHref={"/docs/edge/guides/bootstrapping/internal-cluster-networking"} forwardHref={"/docs/edge/guides/bootstrapping/storage-interfaces"} stepNumber={10} />
