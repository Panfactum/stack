...
We provide a module for deploying Kyverno, [kube\_kyverno](/docs/edge/modules/kube_kyverno/overview).
...
[Kyverno Policies](https://kyverno.io/docs/kyverno-policies/), we provide a module called [kube\_policies](/docs/edge/modules/kube_kyverno/overview).
