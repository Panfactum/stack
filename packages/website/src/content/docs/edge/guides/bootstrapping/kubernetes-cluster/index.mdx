...
<p class="subtitle">
  ...
  using our [aws\_eks](/docs/edge/modules/aws_eks/overview) module.
</p>
...
<MarkdownAlert severity="info">
  ...
  Guide](/docs/edge/guides/bootstrapping/suspend-kubernetes-cluster) to suspend resources and resume as you are setting
  up your cluster.
</MarkdownAlert>
...
[aws_ecr_pull_through_cache](/docs/edge/modules/aws_ecr_pull_through_cache/overview).
...
clusters. More information about this file can be found [here](/docs/edge/reference/configuration/kubernetes).

<MarkdownAlert severity="warning">
  *Every* one of your users will need to set up their own `config.user.yaml` file, and we provide instructions for them
  [here](/docs/edge/guides/getting-started/connect-to-infrastructure).
</MarkdownAlert>
...
additional [terragrunt variables](/docs/edge/reference/configuration/terragrunt-variables).
...
<BootstrappingGuideNav
  backHref={"/docs/edge/guides/bootstrapping/aws-networking"}
  forwardHref={"/docs/edge/guides/bootstrapping/internal-cluster-networking"}
  stepNumber={8}
/>
