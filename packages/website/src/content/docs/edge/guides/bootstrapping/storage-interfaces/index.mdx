...
We provide the [kube_aws_ebs_csi](/docs/edge/modules/kube_aws_ebs_csi/overview) module to deploy the driver.
...
<BootstrappingGuideNav
  backHref={"/docs/edge/guides/bootstrapping/policy-controller"}
  forwardHref={"/docs/edge/guides/bootstrapping/vault"}
  stepNumber={11}
/>
