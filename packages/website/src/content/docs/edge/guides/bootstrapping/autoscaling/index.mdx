...
We provide a module to deploy the server: [kube\_metrics\_server](/docs/edge/modules/kube_metrics_server/overview).
...
We provide a module to deploy the VPA: [kube\_vpa](/docs/edge/modules/kube_vpa/overview).
...
We provide an infrastructure module to deploy it: [kube\_karpenter](/docs/edge/modules/kube_karpenter/overview).
...
the [kube\_karpenter\_node\_pools](/docs/edge/modules/kube_karpenter_node_pools/overview) module.
...
We provide an alternative scheduler in [kube\_scheduler](/docs/edge/modules/kube_scheduler/overview)
...
We provide a module [kube\_keda](/docs/edge/modules/kube_keda/overview) for deploying and managing KEDA.
