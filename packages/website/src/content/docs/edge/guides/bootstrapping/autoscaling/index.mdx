...
and resource optimization, see our [concept docs.](/edge/concepts/autoscaling)
...
We provide a module to deploy the server: [kube\_metrics\_server](/edge/reference/infrastructure-modules/direct/kubernetes/kube_metrics_server).
...
We provide a module to deploy the VPA: [kube\_vpa](/edge/reference/infrastructure-modules/direct/kubernetes/kube_vpa).
...
We provide an infrastructure module to deploy it: [kube\_karpenter](/edge/reference/infrastructure-modules/direct/kubernetes/kube_karpenter).
...
the [kube\_karpenter\_node\_pools](/edge/reference/infrastructure-modules/direct/kubernetes/kube_karpenter_node_pools) module.
...
We provide an alternative scheduler in [kube\_scheduler](/edge/reference/infrastructure-modules/direct/kubernetes/kube_scheduler)
...
We provide a module [kube\_keda](/edge/reference/infrastructure-modules/direct/kubernetes/kube_keda) for deploying and managing KEDA.
