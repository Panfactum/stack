...
optimization, see our [concept docs.](/docs/edge/concepts/autoscaling)
...
We provide a module to deploy the server: [kube_metrics_server](/docs/edge/modules/kube_metrics_server/overview).
...
We provide a module to deploy the VPA: [kube_vpa](/docs/edge/modules/kube_vpa/overview).
...
We provide an infrastructure module to deploy it: [kube_karpenter](/docs/edge/modules/kube_karpenter/overview).
...
[kube_karpenter_node_pools](/docs/edge/modules/kube_karpenter_node_pools/overview) module.
...
We provide an alternative scheduler in [kube_scheduler](/docs/edge/modules/kube_scheduler/overview) (`panfactum`) that
...
We provide a module [kube_keda](/docs/edge/modules/kube_keda/overview) for deploying and managing KEDA.
...
<BootstrappingGuideNav
  backHref={"/docs/edge/guides/bootstrapping/service-mesh"}
  forwardHref={"/docs/edge/guides/bootstrapping/inbound-networking"}
  stepNumber={15}
/>
