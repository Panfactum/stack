...
guide, but we do in our [concept documentation.](/docs/edge/concepts/networking/cluster-networking)
...
We provide a module to deploy it: [kube_external_dns](/docs/edge/modules/kube_external_dns/overview)
...
We provide a module to deploy it: [kube_aws_lb_controller](/docs/edge/modules/kube_aws_lb_controller/overview)
...
We provide a module to deploy it: [kube_ingress_nginx](/docs/edge/modules/kube_ingress_nginx/overview).
...
7. Moreover, notice that NGINX properly secures the site in a standard way by setting security headers for the browser.
   ...
   This is accomplished by our [kube_ingress](/docs/edge/modules/kube_ingress/overview) module. `kube_vault` uses it
...
We provide a bastion deployment module: [kube_bastion](/docs/edge/modules/kube_bastion/overview).
...
4. Update the values to the correct values for your setup. See the
   [reference docs](/docs/edge/reference/configuration/ssh) for more information.
