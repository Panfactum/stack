...
We provide a module to deploy it: [kube\_external\_dns](/docs/edge/modules/kube_external_dns/overview)
...
We provide a module to deploy it: [kube\_aws\_lb\_controller](/docs/edge/modules/kube_aws_lb_controller/overview)
...
We provide a module to deploy it: [kube\_ingress\_nginx](/docs/edge/modules/kube_ingress_nginx/overview).
...
7. Moreover, notice that NGINX properly secures the site in a standard way by setting security headers for the browser. You
   ...
   This is accomplished by our [kube\_ingress](/docs/edge/modules/kube_ingress/overview)
...
We provide a bastion deployment module: [kube\_bastion](/docs/edge/modules/kube_bastion/overview).
