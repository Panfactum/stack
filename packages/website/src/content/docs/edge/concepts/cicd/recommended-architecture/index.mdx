...
* **CI / CD should be driven by [GitOps](https://about.gitlab.com/topics/gitops/)**
  ...
  All changes to your running software systems (including [configuration-as-code](/edge/concepts/iac#configuration-as-code) changes)
...
* This CI / CD system is driven by [Argo Events](https://argoproj.github.io/argo-events/) (receiving webhook notifications
  ...
  [detailed instructions for installing and maintaining it](/edge/guides/addons/workflow-engine/installing).
