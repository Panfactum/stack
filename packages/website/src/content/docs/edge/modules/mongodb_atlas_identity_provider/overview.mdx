...
[wf_tf_deploy](/docs/edge/modules/wf_tf_deploy/overview) module, you will also need to pass in the keys:
...
[Sync Authentik with the Atlas Settings](/docs/edge/modules/authentik_mongodb_atlas_sso/overview) section.
