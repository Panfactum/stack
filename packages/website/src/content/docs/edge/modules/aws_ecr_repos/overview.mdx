...
When provided, this overrides the default rules and the `expire_all_images` and `expiration_rules` settings, giving you
full control over the [lifecycle policy](https://docs.aws.amazon.com/AmazonECR/latest/userguide/LifecyclePolicies.html).
