...
environment variables in our [kube\_deployment](/docs/edge/modules/kube_deployment/overview) module.
...
(provided by [kube\_pvc\_autoresizer](/docs/edge/modules/kube_pvc_autoresizer/overview))
...
[kube\_disruption\_window\_controller](/docs/edge/modules/kube_disruption_window_controller/overview)
submodule.
