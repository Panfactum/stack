...
### pgbouncer\_ignore\_startup\_parameters

Description: A list of startup parameters that PgBouncer should ignore when sent by clients. Useful when clients (e.g., JDBC drivers) send parameters like search\_path that PgBouncer does not support.
