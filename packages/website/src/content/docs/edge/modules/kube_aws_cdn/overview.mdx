...
output from instances of the [kube_ingress](/docs/edge/modules/kube_ingress/overview)
module and forwarding them to the [aws_cdn](/docs/edge/modules/aws_cdn/overview) module.

This module takes the same arguments as `aws_cdn`, so see it's [module documentation](/docs/edge/modules/aws_cdn/overview)
