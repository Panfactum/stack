      ...
      >
        {tabs.map(({ text, href }) => (
          <Tab
            ...
            href={href}
            component={Link}
            className={`normal-case text-black min-h-[2.2rem] h-[2.2rem] min-w-[40px] lg:min-w-[60px] px-4 lg:px-6 py-2 lg:py-4 text-xs sm:text-base ${text === value ? 'font-semibold' : 'font-normal'}`}
          />
        ))}
      </Tabs>
    </TabContainer>
