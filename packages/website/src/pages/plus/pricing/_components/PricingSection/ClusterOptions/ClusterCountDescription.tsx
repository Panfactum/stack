...
const ClusterCountDescription = () => (
  <CalculatorDescriptionContainer>
    <p>
      ...
      For every component, we proactively deploy the latest updates and security
      patches as well as provide frontline support (up to and including patching
      the upstream projects if necessary).
    </p>
    <p>Each cluster includes the following:</p>
    <ul class="flex list-decimal flex-col gap-3 pl-6">
      <li>
