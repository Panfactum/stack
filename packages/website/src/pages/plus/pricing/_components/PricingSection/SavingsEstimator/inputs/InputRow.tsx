...
import InfoIcon from "@/pages/plus/pricing/_components/PricingSection/SavingsEstimator/InfoIcon";
...
const InputRow: ParentComponent<InputRowProps> = (props) => {
  ...
  return (
    <>
      <div
        class={clsx(
          "flex w-full flex-col gap-y-1 overflow-visible px-8 py-3 md:gap-y-2 md:py-6 lg:flex-row",
      ...
      >
        ...
        >
          <Show when={props.description} fallback={props.title}>
            <button
        ...
        <div
          class={clsx(
            "grid w-full basis-4/5 gap-4",
            props.withPrice
              ? "grid-cols-2 items-end xl:grid-cols-3"
