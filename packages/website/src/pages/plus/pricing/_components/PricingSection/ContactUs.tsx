...
const ContactUs: Component = () => {
  ...
  return (
    <div class="mt-10 flex flex-col items-center justify-between overflow-hidden rounded-3xl bg-white shadow-md md:flex-row dark:bg-gray-dark-mode-950">
      <div class="flex items-center gap-4 px-4 py-6 md:px-8">
        <div class="flex flex-col items-center gap-y-2 md:items-start">
          ...
          <Button
            ...
            class="mt-4 flex cursor-pointer items-center gap-4 text-nowrap rounded-md bg-gold-300 px-4 py-2 font-semibold text-gray-light-mode-800 shadow shadow-gray-dark-mode-400 hover:bg-gray-dark-mode-500"
          >
            <span class="size-6">
              <CalendarIcon />
            </span>
