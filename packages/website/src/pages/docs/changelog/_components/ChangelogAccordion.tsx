            ...
            >
              <Accordion.Trigger
                class={`
                  ...
                  border-0 bg-transparent p-1 text-left font-medium
                  transition-colors duration-200
                  [&[data-expanded]_svg]:rotate-45
                `}
              >
              ...
              <Accordion.Content class={clsx(styles.accordionContent, "pl-12")}>
