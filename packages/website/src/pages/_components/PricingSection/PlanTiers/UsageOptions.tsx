...
const DiscountBadge = (props: { discount: number; clusterPrice: number }) => {
  return (
    <Show when={props.discount > 1}>
      <div class="flex h-6 items-center justify-center gap-2 text-nowrap rounded bg-brand-100 px-2 py-0 text-xs text-brand-800 ring-1 ring-brand-500 md:text-sm">
