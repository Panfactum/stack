...
const AnnualSpendCommitmentDescription = () => (
  <CalculatorDescriptionContainer>
    ...
    <p>
      The commitment is decided at contract signing but payments are still made monthly.
    </p>
    <p>
      This can be adjusted upward at any point to ensure that new workloads can receive the discounted rate.
      Every year at contract renewal you will have the opportunity to rightsize the committed spend
      to your current footprint.
    </p>
  </CalculatorDescriptionContainer>
);
