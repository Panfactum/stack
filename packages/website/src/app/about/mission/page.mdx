...
While the platform should be hackable, it must also Just Work&#8482; out-of-the-box without users needing to
...
The success of most software companies is constrained by how quickly and robustly can its engineers write and
deploy new software.
...
We believe a platform can only be successful if its users feel like they _own_ it. That feeling own comes
with robust understanding of _How_ it works and _Why_ it came to be as it is.
...
As a result, our documentation and guides are as important as the code we write. If users havehttps://github.com/DeterminateSystems/nix-installer unanswered questions,
