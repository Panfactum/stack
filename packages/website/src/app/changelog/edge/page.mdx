...
* Support for Cloudflare in [kube_external_dns](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_external_dns) and [kube_cert_issuers](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_cert_issuers)
...
* Changes the `external-dns` policy to `sync`
