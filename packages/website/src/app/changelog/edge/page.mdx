...
* This release contains a major version upgrade to Linkerd.
  **To upgrade with no downtime, you MUST deploy the upgraded [kube\_linkerd](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_linkerd) is upgraded
