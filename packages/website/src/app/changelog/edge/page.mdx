...
* [kube\_karpenter](/docs/edge/reference/infrastructure-modules/kubernetes/kube_karpenter) has upgraded the Karpenter
...
* [kube\_karpenter\_node\_pools](/docs/edge/reference/infrastructure-modules/kubernetes/kube_karpenter_node_pools)
...
* [aws_ecr_pull_through_cache_addresses](/docs/edge/reference/infrastructure-modules/aws/aws_ecr_pull_through_cache_addresses)
...
* [kube\_deployment](/docs/edge/reference/infrastructure-modules/kubernetes/kube_deployment),
  ...
  [kube\_cron\_job](/docs/edge/reference/infrastructure-modules/kubernetes/kube_cron_job),
...
- Adds phone number validation in [aws\_account](/docs/edge/reference/infrastructure-modules/aws/aws_account).

- Adds `cors_enabled` (default: `false`) input variable to [kube\_vault](/docs/edge/reference/infrastructure-modules/kubernetes/kube_vault)
...
* Addresses an issue in [kube\_authentik](/docs/edge/reference/infrastructure-modules/kubernetes/kube_authentik)
  that prevented the SSO login pop-up from working.

* Implements custom CORS handling logic in [kube\_ingress](/docs/edge/reference/infrastructure-modules/kubernetes/kube_ingress)
