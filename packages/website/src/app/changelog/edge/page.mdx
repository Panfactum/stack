...
* Implemented custom CORS handling logic in [kube\_ingress](/docs/edge/reference/infrastructure-modules/kubernetes/kube_ingress)
...
* Remove invalid failure cases when using `pf-get-vault-token` in Terragrunt and improve failure messaging.
