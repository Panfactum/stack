...
* Adds [authentik_atlas_mongodb_sso](docs/edge/reference/infrastructure-modules/direct/authentik/authentik_atlas_mongodb_sso) module for setting up the Authentik Application and Provider for Atlas MongoDB
