...
configuration files.](/docs/reference/terragrunt-variables) For example, you may want to use a different provider configuration to pull in your specific
...
We provide ready-made configuration for many providers (see the [full list here](/docs/reference/terragrunt-variables)).
...
configuration variables, see the [reference docs](/docs/reference/terragrunt-variables).
