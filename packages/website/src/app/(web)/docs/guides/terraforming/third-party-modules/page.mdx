...
...
terraform {
   source = "github.com/Panfactum/stack.git/packages/terraform//aws_eks?ref=1.0.0"
}
...
```
...
```hcl
module "pod_template" {
  source       = "github.com/Panfactum/stack.git/packages/terraform//kube_pod?ref=1.0.0"
...
- You should `source` Panfactum modules via `github.com/Panfactum/stack.git/packages/terraform//<module_name>?ref=<version>` (note the position of the `//`).
