...
Unfortunately, there is no step-by-step guide that can resolve all issues with terragrunt and terraform. However,
...
- Review the [debugging documentation](https://developer.hashicorp.com/terraform/internals/debugging) provided by the terraform team