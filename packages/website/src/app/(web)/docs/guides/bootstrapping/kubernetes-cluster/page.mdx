...
<MarkdownGuideNav backHref={"./aws-networking"} forwardHref={"./internal-cluster-networking"} stepNumber={8} totalSteps={19} progressLabel={"Panfactum Bootstrapping Guide:"} />
