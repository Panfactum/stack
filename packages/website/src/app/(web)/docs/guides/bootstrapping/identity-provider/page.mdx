...
6. Log into the AWS web console and navigate to the SES service. Under "Get set up," notice that your SES configuration
   ...
   Depending on your needs, you may need to request production access to authorize your account for more permissive
   email sending. AWS adds this extra gate-keeping step to guard against spam senders.
