...
check out our [concept documentation.](/docs/concepts/networking/cluster-networking#service-mesh)

## Deploy Linkerd2

[Linkerd](https://linkerd.io/2.15/overview/) is likely the most popular service mesh for Kubernetes,
and we provide a module for deploying it: [kube\_linkerd](/docs/reference/infrastructure-modules/kube_linkerd)
...
<BootstrappingGuideNav backHref={"/docs/guides/bootstrapping/certificate-management"} forwardHref={"/docs/guides/bootstrapping/autoscaling"} stepNumber={13} />
