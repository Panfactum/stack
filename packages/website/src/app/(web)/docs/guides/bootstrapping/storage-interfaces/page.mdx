...
import storageClassesImg from './storage-clases.jpg'
...
We provide the [kube_aws_ebs_csi](../../reference/terraform-modules/kube_aws_ebs_csi) module to deploy the driver.
...
We provide the [kube_secrets_csi](../../reference/terraform-modules/kube_secrets_csi) module to deploy the driver.
...
We will test the storage drivers in the [next section where we deploy Vault](./vault) (which needs persistent storage).