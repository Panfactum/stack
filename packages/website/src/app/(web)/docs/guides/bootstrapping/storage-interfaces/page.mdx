...
We provide the [kube\_aws\_ebs\_csi](/docs/reference/infrastructure-modules/kube_aws_ebs_csi) module to deploy the driver.
...
We provide the [kube\_secrets\_csi](/docs/reference/infrastructure-modules/kube_secrets_csi) module to deploy the driver.
