...
* You have a top-level directory for **every** environment we created in the previous [Preparing AWS](./preparing-aws) guide.
...
For more information about releases and support, see our [guide to releases.](../versioning/releases)
...
<MarkdownGuideNav backHref={"./preparing-aws"} forwardHref={"./infrastructure-as-code"} stepNumber={4} totalSteps={19} progressLabel={"Panfactum Bootstrapping Guide:"} />
