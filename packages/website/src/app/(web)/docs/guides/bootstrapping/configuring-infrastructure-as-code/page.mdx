...
Pick the branch you want to use and make sure it is set as the `PF_REPO_PRIMARY_BRANCH` (per the [docs](/docs/reference/repo-variables)).
...
Pick the folder you want to use and make sure it is set as the `PF_ENVIRONMENTS_DIR` (per the [docs](/docs/reference/repo-variables)).
...
* They can each contain *any and every key* found in this [reference document](/docs/reference/terragrunt-variables).
