...
5. Open your [stack repo](/docs/guides/bootstrapping/installing-devenv) locally. We will be setting up your [AWS configuration and
   credentials](https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-files.html) files in your `PF_AWS_DIR` directory ([reference](/docs/reference/repo-variables))
