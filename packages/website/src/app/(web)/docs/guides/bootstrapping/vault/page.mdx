...
We will use the [kube\_vault](../../references/terraform-modules/kube_vault) terraform module to deploy
...
via the [vault\_core\_resources](../../reference/terraform-modules/vault_core_resources) module.
...
Let's now deploy [vault\_core\_resources](../../reference/terraform-modules/vault_core_resources):
