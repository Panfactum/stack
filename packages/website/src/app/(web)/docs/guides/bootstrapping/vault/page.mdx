...
We will use the [kube\_vault](/docs/reference/infrastructure-modules/kube_vault) infrastructure module to deploy
...
via the [vault\_core\_resources](/docs/reference/infrastructure-modules/vault_core_resources) module.
...
Let's now deploy [vault\_core\_resources](/docs/reference/infrastructure-modules/vault_core_resources):
...
in the [prior section](/docs/guides/bootstrapping/storage-interfaces).
...
<BootstrappingGuideNav backHref={"/docs/guides/bootstrapping/storage-interfaces"} forwardHref={"/docs/guides/bootstrapping/certificate-management"} stepNumber={11} />
