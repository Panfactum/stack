...
Install the basic kubernetes cluster networking primitives via the [kube\_cilium](../../reference/terraform-modules/kube_cilium)
module.
...
<MarkdownGuideNav backHref={"./kubernetes-cluster"} forwardHref={"./storage-interfaces"} stepNumber={9} totalSteps={19} progressLabel={"Panfactum Bootstrapping Guide:"} />
