...
Install the basic kubernetes cluster networking primitives via the [kube_cilium](../../reference/terraform-modules/kube_cilium)
module.
...
we recommend reviewing the [concept documentation](../../concepts/networking/cluster-networking) for more
information.
...
1. Create a new directory adjacent to your cluster called `kube_cilium`
