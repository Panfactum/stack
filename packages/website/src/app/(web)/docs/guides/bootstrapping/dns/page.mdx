...
2. Add a new `aws_registered_domains` folder to your `management` environment in the `global` region.

3. Add a new `terragrunt.hcl` file that looks like [this](https://github.com/Panfactum/stack/blob/__currentPanfactumVersion__/packages/reference/environments/management/global/aws_registered_domains/terragrunt.hcl).
...
3. Create a `terragrunt.hcl` that looks like [this](https://github.com/Panfactum/stack/blob/__currentPanfactumVersion__/packages/reference/environments/management/global/aws_delegated_zones_production/terragrunt.hcl). [^4]
