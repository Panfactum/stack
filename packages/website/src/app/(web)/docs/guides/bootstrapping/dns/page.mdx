...
[aws\_registered\_domains](../../reference/terraform-modules/aws_registered_domains) module. [^1]
...
[aws\_delegated\_zones](../../reference/terraform-modules/aws_delegated_zones) will provide the relevant setup
for this to work.
...
If you have static records to deploy, you can use our [aws\_dns\_records](../../reference/terraform-modules/aws_dns_records)
...
<BootstrappingGuideNav backHref={"./infrastructure-as-code"} forwardHref={"./aws-networking"} stepNumber={6} />
