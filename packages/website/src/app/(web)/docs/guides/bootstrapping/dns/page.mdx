...
<MarkdownAlert severity="warning">
  ...
  3. Prepare in advance to deploy the [aws\_dns\_records](../../reference/terraform-modules/aws_dns_records) module from the following sections.
  4. Apply the [aws\_registered\_domains](../../reference/terraform-modules/aws_registered_domains) module from this section,
     and immediately apply the aws\_dns\_records modules afterwards.
