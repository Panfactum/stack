...
We will use the [aws\_vpc](/docs/reference/infrastructure-modules/aws_vpc) module to deploy the VPC.
...
See the [aws\_vpc](/docs/reference/infrastructure-modules/aws_vpc) documentation for more details and to decide if it is right for you
(it probably is).

### Deploy the AWS VPC Module

We will now deploy the [aws\_vpc](/docs/reference/infrastructure-modules/aws_vpc) module via terragrunt:
