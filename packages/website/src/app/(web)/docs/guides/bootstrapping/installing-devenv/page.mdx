...
For the full list of values you must set, please refer to [these reference docs](/docs/reference/repo-variables).
...
For the full list of available values, please refer to [these reference docs](/docs/reference/dotenv).
