...
Follow this [guide section](/docs/guides/getting-started/install-tooling) to install a few prerequisite tools.
...
1. Create a `devenv.nix` file in the root of your repo. We recommend starting with the below template and expanding it
   ...
   provide a [dedicated guide](/docs/guides/developer-environment/customizing) for customizing your devenv.
...
For the full list of values you must set, please refer to [these reference docs](/docs/reference/configuration/repo-variables).
...
For the full list of available values, please refer to [these reference docs](/docs/reference/configuration/dotenv).
...
<BootstrappingGuideNav backHref={"/docs/guides/bootstrapping/overview"} forwardHref={"/docs/guides/bootstrapping/preparing-aws"} stepNumber={2} />
