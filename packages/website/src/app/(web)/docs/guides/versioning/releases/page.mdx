...
You can find all the supported releases [here](/docs/reference/releases).
...
For example, `stablle.24-01.5` represents the fifth patch to the major version released in January 2024.
...
For example, version `stable.24-01.X` will receive support until the end of January 2025.
