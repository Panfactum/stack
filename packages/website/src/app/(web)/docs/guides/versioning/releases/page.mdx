...
### Community Edition Format

Community edition release will be of the format:
...
### Community Edition Cadence

We have no set cadence for the community stack, but generally we will release changes 2-5 times per month.

### Community Edition Support

We offer extended support and enhanced resolution SLAs in our enterprise edition only (see below).

## Enterprise Edition Releases

You can find all the supported releases [here](../../reference/releases).

### Enterprise Edition Format
