...
**Source Code:** [Link](https://github.com/Panfactum/stack/tree/__currentPanfactumVersion__/packages/infrastructure/kube_rbac)
...
* This requires the cluster first be deployed via the [aws\_eks module](/docs/reference/infrastructure-modules/aws_eks).
