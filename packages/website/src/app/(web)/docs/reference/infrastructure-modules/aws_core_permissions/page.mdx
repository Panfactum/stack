...
**Source Code:** [Link](https://github.com/Panfactum/stack/tree/__currentPanfactumVersion__/packages/infrastructure/aws_core_permissions)
...
### <a name="output_billing_admin_policy_json" /> [billing\_admin\_policy\_json](#output_billing_admin_policy_json)
