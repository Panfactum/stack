...
**Source Code:** [Link](https://github.com/Panfactum/stack/tree/__currentPanfactumVersion__/packages/infrastructure/kube_sa_auth_aws)
...
assigned in the [aws\_vpc](/docs/reference/infrastructure-modules/aws_vpc) and [aws\_eks](/docs/reference/infrastructure-modules/aws_eks)
