...
This file instructs the `pf-update-ssh --build` command how to generate the bastion connecting settings
...
| `module` | The path to the `kube_bastion` module deployment relative to the `PF_ENVIRONMENTS_DIR` directory   | `env/region/kube_bastion`        |
