...
| `panfactum.com/stack-edition` | Which type of Panfactum stack the module deploying this resource is a part of (`community` or `enterprise`) |
...
You can add arbitrary extra tags to the resources you deploy. See [this guide](../guides/terraforming/deploying-modules#resource-tagging) for instructions.
