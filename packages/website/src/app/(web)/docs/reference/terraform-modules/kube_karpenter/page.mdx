...
### <a name="input_eks_node_instance_profile" /> [eks\_node\_instance\_profile](#input_eks_node_instance_profile)

Description: The name of the instance profile to use for the nodes

Type: `string`

### <a name="input_eks_node_role_arn" /> [eks\_node\_role\_arn](#input_eks_node_role_arn)
