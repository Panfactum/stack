...
### <a name="input_oidc_auth_token_lifetime_seconds"></a> [oidc\_auth\_token\_lifetime\_seconds](#input\_oidc\_auth\_token\_lifetime\_seconds)
...
### <a name="input_vault_url"></a> [vault\_url](#input\_vault\_url)
