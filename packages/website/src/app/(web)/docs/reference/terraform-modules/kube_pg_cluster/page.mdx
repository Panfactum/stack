...
### <a name="module_client_certs" /> [client\_certs](#module_client_certs)
...
### <a name="module_irsa" /> [irsa](#module_irsa)
...
### <a name="module_s3_bucket" /> [s3\_bucket](#module_s3_bucket)

Source: [aws\_s](./aws_s)3\_private\_bucket

### <a name="module_server_certs" /> [server\_certs](#module_server_certs)
