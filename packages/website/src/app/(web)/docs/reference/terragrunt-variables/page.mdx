...
| `pf_stack_type`    | string | Configures `include.panfactum.locals.pf_stack_source`. The edition of the Panfactum stack you are using. One of: `community`, `enterprise`, `local`.                                                                                                        | `global.yaml`      |
