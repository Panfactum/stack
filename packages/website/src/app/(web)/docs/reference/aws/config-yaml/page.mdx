...
This file instructs the `pf-update-aws --build` command how to generate the aws config file (`config`).

An example file can be found [here.](https://github.com/Panfactum/stack/tree/__currentPanfactumVersion__/packages/reference/.aws/config.yaml)
