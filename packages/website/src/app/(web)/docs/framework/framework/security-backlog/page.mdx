...
go about disclosing issues. The gold standard would be to provide an intake form that directly drops reported
issues into your backlog for triaging.

## Preventing Security Issues

Similar to [preventing downtime](./downtime-visibility#preventing-downtime), each security
