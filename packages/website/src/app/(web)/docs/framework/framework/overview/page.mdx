...
In software development, your *platform* is the set of practices and systems you use to reliability and rapidly build, deploy, and operate
...
*Platform engineering* is the process of designing those practices and systems within
...
[^1]: Often a comparison is made between [devops](https://en.wikipedia.org/wiki/DevOps) and platform engineering. There is indeed substantial overlap, but when
    it comes to the specific *roles* that you see in the wild, devops roles tend to be more tactical (e.g., "manage this
...
[^2]: Platform engineering can be considered the technical complement to people-and-process focused engineering managers. **Together,
...
In this *Framework* section of the Panfactum documentation, we provide recommendations for what you can do as a platform
engineer to improve awareness and alignment. This complements the Panfactum *Stack*, which aims to reduce the effort needed to design, deploy, and maintain an
effective foundational platform by > 95%.

## Gaining Organizational Awareness

Before proposing any platform improvements, the first priority of a platform engineer is to provide organizational
awareness into the state of the platform. This awareness is critical for prioritizing the areas of highest impact
...
* [Downtime visibility](./downtime-visibility)
...
* [Automation](../pillars/automation)

* [Observability](../pillars/observability)

* [Security](../pillars/security)

* [Resiliency](../pillars/resiliency)

* [Performance](../pillars/performance)

* [Immediate Integration](../pillars/immediate-integration)

* [Efficiency](../pillars/efficiency)

* [Coordination](../pillars/coordination)
...
It is finally time to get to work on improving the platform!
...
but our holistic approach unlocks synergies that are simply not possible when duct-taping together many independent managed
services.

To learn more, check out our [bootstrapping guide](/docs/guides/bootstrapping/overview) which takes you step-by-step through
