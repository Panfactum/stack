...
* Locality-aware traffic routing: Improve performance by ensuring traffic is always
  routed to the closest applicable server. Eliminate [cross-AZ network charges](https://aws.amazon.com/blogs/architecture/overview-of-data-transfer-costs-for-common-architectures/)
  whenever possible.

* Circuit breaking: Reroute traffic from unhealthy or resource-constrained pods to improve overall cluster resiliency.
...
You can see our implementation in the [kube\_linkerd](../../reference/terraform-modules/kube_linkerd) terraform module.
