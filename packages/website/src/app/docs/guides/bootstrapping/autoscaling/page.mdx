...
We provide a module to deploy the server: [kube\_metrics\_server](/docs/reference/infrastructure-modules/kubernetes/kube_metrics_server).
...
We provide a module to deploy the VPA: [kube\_vpa](/docs/reference/infrastructure-modules/kubernetes/kube_vpa).
...
We provide an infrastructure module to deploy it: [kube\_karpenter](/docs/reference/infrastructure-modules/kubernetes/kube_karpenter).
...
Those are defined in the [kube\_karpenter\_node\_pools](/docs/reference/infrastructure-modules/kubernetes/kube_karpenter_node_pools) module.
...
<BootstrappingGuideNav backHref={"/docs/guides/bootstrapping/service-mesh"} forwardHref={"/docs/guides/bootstrapping/inbound-networking"} stepNumber={14} />
