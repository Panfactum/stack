...
We provide a module to deploy the server: [kube\_metrics\_server](/docs/reference/infrastructure-modules/kube_metrics_server).
...
We provide a module to deploy the VPA: [kube\_vpa](/docs/reference/infrastructure-modules/kube_vpa).
...
We provide an infrastructure module to deploy it: [kube\_karpenter](/docs/reference/infrastructure-modules/kube_karpenter).
...
Those are defined in the [kube\_karpenter\_node\_pools](/docs/reference/infrastructure-modules/kube_karpenter_node_pools) module.
