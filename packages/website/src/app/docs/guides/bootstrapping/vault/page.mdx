...
We will use the [kube\_vault](/docs/reference/infrastructure-modules/kubernetes/kube_vault) infrastructure module to deploy
...
via the [vault\_core\_resources](/docs/reference/infrastructure-modules/vault/vault_core_resources) module.
...
Let's now deploy [vault\_core\_resources](/docs/reference/infrastructure-modules/vault/vault_core_resources):
