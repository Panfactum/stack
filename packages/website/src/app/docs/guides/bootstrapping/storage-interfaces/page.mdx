...
We provide the [kube\_aws\_ebs\_csi](/docs/reference/infrastructure-modules/kubernetes/kube_aws_ebs_csi) module to deploy the driver.
...
We provide the [kube\_secrets\_csi](/docs/reference/infrastructure-modules/kubernetes/kube_secrets_csi) module to deploy the driver.
...
<BootstrappingGuideNav backHref={"/docs/guides/bootstrapping/internal-cluster-networking"} forwardHref={"/docs/guides/bootstrapping/vault"} stepNumber={10} />
