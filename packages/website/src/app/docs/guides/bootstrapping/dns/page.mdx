...
[aws\_registered\_domains](/docs/reference/infrastructure-modules/aws_registered_domains) module. [^1]
...
[^1]: The domains will have the following defaults you can override if desired:
    ...
    refer to the [module documentation](/docs/reference/infrastructure-modules/aws_registered_domains).
...
[aws\_delegated\_zones](/docs/reference/infrastructure-modules/aws_delegated_zones) will provide the relevant setup
for this to work.
...
If you have static records to deploy, you can use our [aws\_dns\_records](/docs/reference/infrastructure-modules/aws_dns_records)
