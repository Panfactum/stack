...
We provide a module to deploy the operator: [kube\_cloudnative\_pg](/docs/reference/infrastructure-modules/kube_cloudnative_pg).
...
We provide a module [kube\_pg\_cluster](/docs/reference/infrastructure-modules/kube_pg_cluster) that you can use in your
projects to do this.
...
module called [test\_kube\_pg\_cluster](/docs/reference/infrastructure-modules/kube_pg_cluster) which is a thin
wrapper around [kube\_pg\_cluster](/docs/reference/infrastructure-modules/kube_pg_cluster).
...
manner. Instead, you can run our [kube\_redis\_sentinel](/docs/reference/infrastructure-modules/kube_redis_sentinel)
directly.
