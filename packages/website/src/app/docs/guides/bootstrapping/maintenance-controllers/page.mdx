...
We provide a module to deploy this controller: [kube\_reloader](/docs/reference/infrastructure-modules/kube_reloader).
...
We provide a module for the Descheduler: [kube\_descheduler](/docs/reference/infrastructure-modules/kube_descheduler).
...
via the [kube\_aws\_ebs\_csi](/docs/reference/infrastructure-modules/kube_aws_ebs_csi) module we installed in
...
We provide a module to deploy the external-snapshotter: [kube\_external\_snapshotter](/docs/reference/infrastructure-modules/kube_external_snapshotter).
...
We provide a module to deploy this functionality: [kube\_velero](/docs/reference/infrastructure-modules/kube_velero).
