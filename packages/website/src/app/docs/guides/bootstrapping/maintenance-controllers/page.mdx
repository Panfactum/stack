...
We provide a module to deploy this controller: [kube\_reloader](/docs/reference/infrastructure-modules/kubernetes/kube_reloader).
...
We provide a module for the Descheduler: [kube\_descheduler](/docs/reference/infrastructure-modules/kubernetes/kube_descheduler).
...
via the [kube\_aws\_ebs\_csi](/docs/reference/infrastructure-modules/kubernetes/kube_aws_ebs_csi) module we installed in
[a prior section](/docs/guides/bootstrapping/storage-interfaces).
...
We provide a module to deploy the external-snapshotter: [kube\_external\_snapshotter](/docs/reference/infrastructure-modules/kubernetes/kube_external_snapshotter).
...
We provide a module to deploy this functionality: [kube\_velero](/docs/reference/infrastructure-modules/kubernetes/kube_velero).
...
<BootstrappingGuideNav backHref={"/docs/guides/bootstrapping/inbound-networking"} forwardHref={"/docs/guides/bootstrapping/databases"} stepNumber={16} />
