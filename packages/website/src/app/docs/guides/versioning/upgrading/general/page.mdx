...
Before you being, please ensure you have reviewed the guide for [pinning the Panfactum version](/docs/guides/versioning/pinning).
...
3. Ensure that the terragrunt `version` for that environment is set to `local` (review [these docs](/docs/guides/iac/first-party-modules)) [^2].
