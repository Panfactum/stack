...
[^1]: The IdP itself should have already been provisioned in the [bootstrapping guide.](/docs/guides/bootstrapping/identity-provider)

If your organization's administrators have not already [provisioned your account](/docs/guides/user-management/provisioning-new-user), ask them now. You
will need to follow [this guide](/docs/guides/user-management/setting-up-new-user) to set up your user for the first time.
...
2. Update the `config.user.yaml` to include the clusters you want to access and what AWS profile you want to use for that access. See
   the [reference docs](/docs/reference/configuration/kubernetes#config.user.yaml) for the specific syntax.
...
* [Learn how to deploy infrastructure using infrastructure-as-code](/docs/guides/iac/deploying-modules)

* [Customize to local devenv](/docs/guides/developer-environment/customizing)

* [Connect to databases](/docs/guides/networking/database-connections)
