...
<ModuleHeader name="aws_ecr_pull_through_cache" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/aws_ecr_pull_through_cache" status="stable" type="direct"/>
...
### <a name="input_docker_hub_access_token"></a> [docker\_hub\_access\_token](#input\_docker\_hub\_access\_token)

Description: The access token of the Docker Hub user that will be used to pull images from Docker Hub

Type: `string`

### <a name="input_docker_hub_username"></a> [docker\_hub\_username](#input\_docker\_hub\_username)

Description: The username of the Docker Hub user that will be used to pull images from Docker Hub

Type: `string`

### <a name="input_github_access_token"></a> [github\_access\_token](#input\_github\_access\_token)
