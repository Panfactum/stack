...
<ModuleHeader name="kube_monitoring" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_monitoring" status="alpha" type="direct" />
...
### <a name="input_grafana_db_recovery_directory" /> [grafana\_db\_recovery\_directory](#input_grafana_db_recovery_directory)
...
### <a name="input_grafana_db_recovery_mode_enabled" /> [grafana\_db\_recovery\_mode\_enabled](#input_grafana_db_recovery_mode_enabled)
...
### <a name="input_grafana_db_recovery_target_time" /> [grafana\_db\_recovery\_target\_time](#input_grafana_db_recovery_target_time)
...
### <a name="output_grafana_db_recovery_directory" /> [grafana\_db\_recovery\_directory](#output_grafana_db_recovery_directory)
