...
<ModuleHeader name="kube_descheduler" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_descheduler" status="stable" type="direct" />
