...
<ModuleHeader name="kube_pvc_annotator" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_pvc_annotator" status="beta" type="submodule" />
