...
<ModuleHeader name="aws_vpc" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/aws_vpc" status="stable" type="direct"/>
...
### <a name="input_vpc_flow_logs_expire_after_days"></a> [vpc\_flow\_logs\_expire\_after\_days](#input\_vpc\_flow\_logs\_expire\_after\_days)
...
### <a name="output_test_config"></a> [test\_config](#output\_test\_config)
