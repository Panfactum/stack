...
<ModuleHeader name="kube_argo_event_source" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_argo_event_source" status="beta" type="submodule" />
