...
<ModuleHeader name="kube_alloy" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_alloy" status="alpha" type="live" />
