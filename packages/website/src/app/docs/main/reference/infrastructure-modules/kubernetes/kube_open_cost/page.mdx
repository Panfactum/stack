...
<ModuleHeader name="kube_open_cost" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_open_cost" status="alpha" type="live" />
