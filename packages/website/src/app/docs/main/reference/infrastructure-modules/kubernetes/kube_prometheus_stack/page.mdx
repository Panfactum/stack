...
<ModuleHeader name="kube_prometheus_stack" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_prometheus_stack" status="alpha" type="live" />
