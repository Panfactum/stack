...
<ModuleHeader name="kube_rbac" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_rbac" status="deprecated" type="direct"/>
