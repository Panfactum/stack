...
<ModuleHeader name="tf_bootstrap_resources" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/tf_bootstrap_resources" status="stable" type="live" />
