...
<ModuleHeader name="kube_pod" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_pod" status="stable" type="submodule"/>
...
[kube\_deployment](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube\_deployment) and [kube\_stateful\_set](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube\_stateful\_set).
