...
<ModuleHeader name="kube_secrets_csi" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_secrets_csi" status="deprecated" type="direct" />
