...
The [kube\_node\_image\_cache\_controller](/docs/main/reference/infrastructure-modules/direct/kubernetes/kube\_node\_image\_cache\_controller) must be installed in order for this to work.

## Debugging

See [`kube_node_image_cache_controller` debugging docs.](/docs/main/reference/infrastructure-modules/direct/kubernetes/kube\_node\_image\_cache\_controller#debugging)
