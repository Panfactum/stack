...
<ModuleHeader name="kube_workflow_spec" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_workflow_spec" status="alpha" type="submodule" />
