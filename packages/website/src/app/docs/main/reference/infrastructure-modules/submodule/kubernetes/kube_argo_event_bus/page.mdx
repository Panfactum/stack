...
# Argo Event Bus
<ModuleHeader name="kube_argo_event_bus" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_argo_event_bus" status="alpha" type="submodule"/>
...
### <a name="input_event_bus_initial_volume_size"></a> [event\_bus\_initial\_volume\_size](#input\_event\_bus\_initial\_volume\_size)
...
### <a name="input_event_bus_storage_class_name"></a> [event\_bus\_storage\_class\_name](#input\_event\_bus\_storage\_class\_name)
