...
| `PF_AWS_DIR`             |          | Path to the AWS CLI configuration directory                                                       | `.aws` (default)           |   |
| `PF_KUBE_DIR`            |          | Path to the Kubernetes configuration directory                                                    | `.kube` (default)          |   |
| `PF_SSH_DIR`             |          | Path to the SSH configuration directory                                                           | `.ssh` (default)           |   |
| `PF_BUILDKIT_DIR`        |          | Path to the BuildKit configuration directory                                                      | `.buildkit` (default)      |   |
