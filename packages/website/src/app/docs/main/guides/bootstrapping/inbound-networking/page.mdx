...
We provide a module to deploy it: [kube\_external\_dns](/docs/main/reference/infrastructure-modules/kubernetes/kube_external_dns)
...
We provide a module to deploy it: [kube\_aws\_lb\_controller](/docs/main/reference/infrastructure-modules/kubernetes/kube_aws_lb_controller)
...
We provide a module to deploy it: [kube\_ingress\_nginx](/docs/main/reference/infrastructure-modules/kubernetes/kube_ingress_nginx).
...
7. Moreover, notice that NGINX properly secures the site in a standard way by setting security headers for the browser. You
   ...
   This is accomplished by our [kube\_ingress](/docs/main/reference/infrastructure-modules/kubernetes/kube_ingress)
...
We provide a bastion deployment module: [kube\_bastion](/docs/main/reference/infrastructure-modules/kubernetes/kube_bastion).
...
<BootstrappingGuideNav backHref={"/docs/edge/guides/bootstrapping/autoscaling"} forwardHref={"/docs/edge/guides/bootstrapping/maintenance-controllers"} stepNumber={15} />
