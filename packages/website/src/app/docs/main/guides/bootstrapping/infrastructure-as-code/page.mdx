...
* [tf\_bootstrap\_resources](/docs/main/reference/infrastructure-modules/utility/tf_bootstrap_resources) (the state backend using AWS [S3](https://aws.amazon.com/s3/) and [DynamoDB](https://aws.amazon.com/dynamodb/))
* [aws\_kms\_encrypt\_key](/docs/main/reference/infrastructure-modules/aws/aws_kms_encrypt_key) (the encryption key using AWS [KMS](https://aws.amazon.com/kms/))
...
The first resource will be the [aws\_account](/docs/main/reference/infrastructure-modules/aws/aws_account) module. This module adds some critical metadata
