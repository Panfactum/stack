...
<BootstrappingGuideNav backHref={"/docs/edge/guides/bootstrapping/storage-interfaces"} forwardHref={"/docs/edge/guides/bootstrapping/certificate-management"} stepNumber={11} />
