...
<BootstrappingGuideNav backHref={"/docs/edge/guides/bootstrapping/service-mesh"} forwardHref={"/docs/edge/guides/bootstrapping/inbound-networking"} stepNumber={14} />
