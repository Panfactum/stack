...
and we provide a module for deploying it: [kube\_linkerd](/docs/main/reference/infrastructure-modules/kubernetes/kube_linkerd)
...
<BootstrappingGuideNav backHref={"/docs/main/guides/bootstrapping/certificate-management"} forwardHref={"/docs/main/guides/bootstrapping/autoscaling"} stepNumber={13} />
