...
<BootstrappingGuideNav backHref={"/docs/edge/guides/bootstrapping/certificate-management"} forwardHref={"/docs/edge/guides/bootstrapping/autoscaling"} stepNumber={13} />
