...
<MarkdownAlert severity="info">
  ...
  * [kube\_rbac](/docs/main/reference/infrastructure-modules/direct/kubernetes/kube_rbac) to allow SSO authentication
    with your Kubernetes clusters. Note that you MUST omit the /aws-reserved/sso.amazonaws.com/us-east-2/
    part of the ARN.

  * [aws\_eks](/docs/main/reference/infrastructure-modules/direct/aws/aws_eks) to allow SSO authentication
    with the cluster KMS encryption key.

  * sops keys (deployed with [aws\_kms\_encrypt\_key](/docs/main/reference/infrastructure-modules/submodule/aws/aws_kms_encrypt_key)) to allow SSO authentication
    with the sops KMS encryption key.

  * [kube\_vault](/docs/main/reference/infrastructure-modules/direct/kubernetes/kube_vault) to allow SSO authentication
...
[authentik\_aws\_sso](/docs/main/reference/infrastructure-modules/direct/authentik/authentik_aws_sso).
...
to automatically set this up: [aws\_iam\_identity\_center\_permissions](/docs/main/reference/infrastructure-modules/direct/aws/aws_iam_identity_center_permissions).
...
2. As AWS KMS keys are special resources that require explicit permission grants, you must re-apply
   ...
   * sops keys deployed with the [aws\_kms\_encrypt\_key](/docs/main/reference/infrastructure-modules/submodule/aws/aws_kms_encrypt_key) module
   * EKS clusters deployed with [aws\_eks](/docs/main/reference/infrastructure-modules/direct/aws/aws_eks)
   * Vault clusters deployed with [kube\_vaults](/docs/main/reference/infrastructure-modules/direct/kubernetes/kube_vault)
...
[authentik\_vault\_sso](/docs/main/reference/infrastructure-modules/direct/authentik/authentik_vault_sso).
...
We also provide a module to configure Vault to work with the above Authentik configuration: [vault\_auth\_oidc](/docs/main/reference/infrastructure-modules/direct/vault/vault_auth_oidc).
