...
5. Open your [stack repo](/docs/main/guides/bootstrapping/installing-devenv) locally. We will be setting up your [AWS configuration and
   credentials](https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-files.html) files in your `aws_dir` directory ([reference](/docs/main/reference/configuration/repo-variables))
