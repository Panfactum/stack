...
<BootstrappingGuideNav backHref={"/docs/edge/guides/bootstrapping/installing-devenv"} forwardHref={"/docs/edge/guides/bootstrapping/configuring-infrastructure-as-code"} stepNumber={3} />
