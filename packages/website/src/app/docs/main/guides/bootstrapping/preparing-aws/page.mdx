...
5. Open your [stack repo](/docs/main/guides/bootstrapping/installing-devenv) locally. We will be setting up your [AWS configuration and
   credentials](https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-files.html) files in your `PF_AWS_DIR` directory ([reference](/docs/main/reference/configuration/repo-variables))
...
<BootstrappingGuideNav backHref={"/docs/main/guides/bootstrapping/installing-devenv"} forwardHref={"/docs/main/guides/bootstrapping/configuring-infrastructure-as-code"} stepNumber={3} />
