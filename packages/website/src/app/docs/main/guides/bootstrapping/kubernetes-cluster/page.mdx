...
and we recommend planning for at minimum {"$"}150 / month / cluster. [^1] [^14]
...
[^14]: To save some cost during the bootstrapping process you can follow the [Kubernetes Cluster Suspension Guide](/docs/main/guides/bootstrapping/suspend-kubernetes-cluster) to suspend resources and resume as you are setting up your cluster.
...
[^6]: For more information on costs and uptime targets, see our [high-availability guide](/docs/main/guides/deploying-workloads/high-availability).
