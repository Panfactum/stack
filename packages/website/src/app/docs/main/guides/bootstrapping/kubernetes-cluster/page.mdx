...
using our [aws\_eks](/docs/main/reference/infrastructure-modules/aws/aws_eks) module.
...
We provide a module for configuring this behavior: [aws\_ecr\_pull\_through\_cache](/docs/main/reference/infrastructure-modules/aws/aws_ecr_pull_through_cache).
...
with the rest of the Panfactum stack. See the [module documentation](/docs/main/reference/infrastructure-modules/aws/aws_eks) if
...
you created in the [aws networking guide](/docs/main/guides/bootstrapping/aws-networking). [^3] This ensures the API server is resilient to an AZ outage.
...
the cluster automatically has cluster access). We will now deploy the [kube\_rbac](/docs/main/reference/infrastructure-modules/kubernetes/kube_rbac)
...
2. Set up a `terragunt.hcl` that looks like [this](https://github.com/Panfactum/stack/blob/__PANFACTUM_VERSION_MAIN__/packages/reference/environments/production/us-east-2/kube_rbac/terragrunt.hcl).
...
as an unexpected AZ outage. These are defined in the [kube\_priority\_classes](/docs/main/reference/infrastructure-modules/kubernetes/kube_priority_classes)
module.
...
2. Set up a `terragunt.hcl` that looks like [this](https://github.com/Panfactum/stack/blob/__PANFACTUM_VERSION_MAIN__/packages/reference/environments/production/us-east-2/kube_priority_classes/terragrunt.hcl).
