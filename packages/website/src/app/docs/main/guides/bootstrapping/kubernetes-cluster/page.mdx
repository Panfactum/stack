...
the cluster automatically has cluster access). We will now deploy the [kube\_rbac](/docs/main/reference/infrastructure-modules/direct/kubernetes/kube_rbac)
...
as an unexpected AZ outage. These are defined in the [kube\_priority\_classes](/docs/main/reference/infrastructure-modules/direct/kubernetes/kube_priority_classes)
module.
