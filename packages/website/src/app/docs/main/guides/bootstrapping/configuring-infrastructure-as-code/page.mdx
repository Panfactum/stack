...
Pick the branch you want to use and make sure it is set as the `repo_primary_branch` (per the [docs](/docs/main/reference/configuration/repo-variables)).
...
Pick the folder you want to use and make sure it is set as the `environments_dir` (per the [docs](/docs/main/reference/configuration/repo-variables)).
...
`environments_dir` must be set up to follow [these conventions](/docs/main/reference/configuration/terragrunt-variables).
