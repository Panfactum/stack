...
* They can each contain *any and every key* found in this [reference document](/docs/main/reference/configuration/terragrunt-variables).
...
* You have a top-level directory for **every** environment we created in the previous [Preparing AWS](/docs/main/guides/bootstrapping/preparing-aws) guide.
...
For more information about releases and support, see our [guide to releases.](/docs/main/guides/versioning/releases)
