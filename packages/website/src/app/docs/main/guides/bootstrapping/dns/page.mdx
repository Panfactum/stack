...
[aws\_registered\_domains](/docs/main/reference/infrastructure-modules/aws/aws_registered_domains) module. [^1]
...
3. Add a new `terragrunt.hcl` file that looks like [this](https://github.com/Panfactum/stack/blob/__PANFACTUM_VERSION_MAIN__/packages/reference/environments/production/global/aws_registered_domains/terragrunt.hcl).
...
[^1]: The domains will have the following defaults you can override if desired:
    ...
    refer to the [module documentation](/docs/main/reference/infrastructure-modules/aws/aws_registered_domains).
...
[aws\_delegated\_zones](/docs/main/reference/infrastructure-modules/aws/aws_delegated_zones) will provide the relevant setup
for this to work.
...
3. Create a `terragrunt.hcl` that looks like [this](https://github.com/Panfactum/stack/blob/__PANFACTUM_VERSION_MAIN__/packages/reference/environments/production/global/aws_delegated_zones_production/terragrunt.hcl). [^4]
...
If you have static records to deploy, you can use our [aws\_dns\_records](/docs/main/reference/infrastructure-modules/aws/aws_dns_records)
