...
[aws\_registered\_domains](/docs/main/reference/infrastructure-modules/direct/aws/aws_registered_domains) module. [^1]
...
[^1]: The domains will have the following defaults you can override if desired:
    ...
    refer to the [module documentation](/docs/main/reference/infrastructure-modules/direct/aws/aws_registered_domains).
...
[aws\_delegated\_zones](/docs/main/reference/infrastructure-modules/direct/aws/aws_delegated_zones) will provide the relevant setup
for this to work.
...
4. Create a `module.yaml`.
   ...
   1. Run `pf-providers-enable` to generate the `module.yaml` and enable the required providers.
...
If you have static records to deploy, you can use our [aws\_dns\_records](/docs/main/reference/infrastructure-modules/direct/aws/aws_dns_records)
