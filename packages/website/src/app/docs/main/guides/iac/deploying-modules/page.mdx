...
* using a [Panfacutm module](/docs/main/guides/iac/panfactum-modules)

* using a [first-party module](/docs/main/guides/iac/first-party-modules) (defined in your infrastructure repo)
...
We provide ready-made configuration for many providers (see the [full list here](/docs/main/reference/configuration/terragrunt-variables)).
...
configuration variables, see the [reference docs](/docs/main/reference/configuration/terragrunt-variables).
