...
Set `PF_IAC_DIR` to that directory per the [reference docs](/docs/main/reference/configuration/repo-variables).
...
* The [configuration-as-code](/docs/main/concepts/iac#configuration-as-code) (e.g., module versions, module inputs, etc.) will **always** be defined
  by the primary integration branch (set by `PF_REPO_PRIMARY_BRANCH`), in this case `main`.
