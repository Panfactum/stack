...
for each provider. For the full list of provider version values, see the [reference docs](/docs/main/reference/infrastructure-modules/overview#provider-versions).
