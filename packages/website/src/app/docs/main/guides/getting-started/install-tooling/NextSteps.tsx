  ...
  if (isBootstrapping) {
    return (
      <div className="mt-2 flex flex-col gap-2">
        <p>
          ...
          {' '}
          <Link
            href="/docs/main/guides/bootstrapping/installing-devshell#install-prerequisite-tooling"
    ...
    return (
      <div className="mt-2 flex flex-col gap-2">
        ...
        <MarkdownGuideNav
          backHref={'/docs/main/guides/getting-started/overview'}
          forwardHref={'/docs/main/guides/getting-started/boot-developer-environment'}
          stepNumber={2}
          totalSteps={4}
