...
use the [kube\_stateful\_set](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube_stateful_set) module.
...
as a part of the [bootstrapping guide.](/docs/main/guides/bootstrapping/storage-interfaces)
...
[kube\_aws\_ebs\_csi](/docs/main/reference/infrastructure-modules/direct/kubernetes/kube_aws_ebs_csi) module.
