...
2. [Create a first-party IaC module](/docs/main/guides/iac/first-party-modules#writing-modules)
   ...
   | [DaemonSet](https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/)            | [kube_daemon_set](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube_daemon_set)         | Runs a pod on every tolerated node in the cluster.                                  |
