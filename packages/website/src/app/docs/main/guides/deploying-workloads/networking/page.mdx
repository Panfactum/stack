...
* [Kubernetes networking concept documentation](/docs/main/concepts/networking/cluster-networking)
...
* [kube\_deployment](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube_deployment)
...
Additionally, we provide a submodule, [kube\_service](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube_service),
...
more background information, see our [concept docs](/docs/main/concepts/networking/cluster-networking#inbound-networking).

The central ingress infrastructure is set up in the [bootstrapping guide](/docs/main/guides/bootstrapping/inbound-networking#deploy-the-ingress-system),
but you will still need to set up individual Ingress resources for each service that you want to expose
to the public internet.

We provide a submodule, [kube\_ingress](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube_ingress),
...
In addition, we provide a submodule [kube\_aws\_cdn](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube_aws_cdn),
...
which generates the mesh (see [concept docs](/docs/main/concepts/networking/cluster-networking#service-mesh)).
