...
- For any module that deploys *stateful* workloads such as [kube_stateful_set](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube_stateful_set) or [kube_pg_cluster](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube_pg_cluster) to Kubernetes,
