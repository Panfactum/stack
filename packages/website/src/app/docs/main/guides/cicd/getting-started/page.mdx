...
<MarkdownAlert severity="info">
  ...
  we do offer an alternative modules for [self-hosted GitHub Actions](/docs/main/guides/addons/github-actions/installing).
</MarkdownAlert>
...
3. Follow our [guide for creating a new Event Bus.](/docs/main/guides/addons/event-bus/installing)
   ...
   1. Set up the relevant source for your specific git hosting provider:
      ...
      * [Webhook](https://argoproj.github.io/argo-events/eventsources/setup/webhook/) (for generic git provider)
