...
[^1]: Argo Events can also be used to trigger many more actions than just Argo Workflows. See our
    [Event Bus Addon](/docs/main/guides/addons/event-bus/primer) guide.
...
We provide a module, [kube\_argo](/docs/main/reference/infrastructure-modules/direct/kubernetes/kube_argo), that
...
2. Add a `terragrunt.hcl` that looks like [this](https://github.com/Panfactum/stack/blob/__PANFACTUM_VERSION_MAIN__/packages/reference/environments/production/us-east-2/kube_argo/terragrunt.hcl).
...
* To start creating your own custom Workflows, take a look at [our documentation](/docs/main/guides/addons/workflow-engine/creating-workflows).

* Deploy some of [our pre-built Workflows](/docs/main/guides/addons/workflow-engine/prebuilt-workflows/overview) for common tasks in the Panfactum Stack

* Learn how to use Workflows for your CI / CD system [here.](/docs/main/guides/cicd/getting-started)

* Learn more about how to leverage Argo Events [here.](/docs/main/guides/addons/event-bus/primer)
