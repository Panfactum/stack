...
via deploying the [Workflow Engine Stack Addon.](/docs/main/guides/addons/workflow-engine/installing)

- Deploying an Event Bus requires writing your own IaC. Be sure you have reviewed [our guide on how to do this in
the Panfactum stack.](/docs/main/guides/iac/first-party-modules)
...
- [kube_argo_event_source](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube_argo_event_source)
- [kube_argo_sensor](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube_argo_sensor)
- [kube_argo_event_bus](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube_argo_event_bus)
...
module "event_bus" {
  source =   "github.com/Panfactum/stack.git//packages/infrastructure//kube_argo_event_bus?ref=__PANFACTUM_VERSION_MAIN__" # pf-update
...
module "event_source" {
  source = "github.com/Panfactum/stack.git//packages/infrastructure//kube_argo_event_source?ref=__PANFACTUM_VERSION_MAIN__" #pf-update
...
module "sensor" {
  source = "github.com/Panfactum/stack.git//packages/infrastructure//infrastructure//kube_argo_sensor?ref=__PANFACTUM_VERSION_MAIN__" #pf-update
