...
If you are deploying Panfactum terraform modules directly, update the `pf_stack_version` [terragrunt variable](/docs/edge/reference/configuration/terragrunt-variables).
