...
[^1]: Argo Events can also be used to trigger many more actions than just Argo Workflows. See our
    [Event Bus Addon](/docs/edge/guides/addons/event-bus/primer) guide.
...
* Learn more about how to leverage Argo Events [here.](/docs/edge/guides/addons/event-bus/primer)
