...
We provide a module to deploy this controller: [kube\_gha](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_gha).
...
To create runners, you will use our [kube\_gha\_runners](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_gha_runners) module.
