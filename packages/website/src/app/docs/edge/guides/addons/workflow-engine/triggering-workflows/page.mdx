...
but it is what it is. The maintainers try to explain it away [here](https://argo-workflows.readthedocs.io/en/latest/workflow-templates/#workflowtemplate-vs-template),
but we personally don't buy it.
