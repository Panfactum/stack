...
Additionally, we provide a submodule, [kube\_service](/docs/edge/reference/infrastructure-modules/submodule/kubernetes/kube_service),
...
We provide a submodule, [kube\_ingress](/docs/edge/reference/infrastructure-modules/submodule/kubernetes/kube_ingress),
...
In addition, we provide a submodule [kube\_aws\_cdn](/docs/edge/reference/infrastructure-modules/submodule/kubernetes/kube_aws_cdn),
