...
We provide both a module to deploy Authentik ([kube\_authentik](/docs/edge/reference/infrastructure-modules/kubernetes/kube_authentik)) and
many modules to connect Authentik to the various systems in the Panfactum stack (e.g., [authentik\_aws\_sso](/docs/edge/reference/infrastructure-modules/authentik/authentik_aws_sso)).
...
We provide a module to do this: [aws\_ses\_domain](/docs/edge/reference/infrastructure-modules/aws/aws_ses_domain).
...
7. (Optional) This module does not configure your DMARC record as you would typically only have one DMARC record
   ...
   to set this up. You can use the [aws\_dns\_records](/docs/edge/reference/infrastructure-modules/aws/aws_dns_records) module to
...
branding: [authentik\_core\_resources](/docs/edge/reference/infrastructure-modules/authentik/authentik_core_resources).
