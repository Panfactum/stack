...
using our [aws\_eks](/docs/edge/reference/infrastructure-modules/aws/aws_eks) module.
...
We provide a module for configuring this behavior: [aws\_ecr\_pull\_through\_cache](/docs/edge/reference/infrastructure-modules/aws/aws_ecr_pull_through_cache).
...
with the rest of the Panfactum stack. See the [module documentation](/docs/edge/reference/infrastructure-modules/aws/aws_eks) if
...
the cluster automatically has cluster access). We will now deploy the [kube\_rbac](/docs/edge/reference/infrastructure-modules/kubernetes/kube_rbac)
...
as an unexpected AZ outage. These are defined in the [kube\_priority\_classes](/docs/edge/reference/infrastructure-modules/kubernetes/kube_priority_classes)
module.
