...
* [tf\_bootstrap\_resources](/docs/edge/reference/infrastructure-modules/utility/tf_bootstrap_resources) (the state backend using AWS [S3](https://aws.amazon.com/s3/) and [DynamoDB](https://aws.amazon.com/dynamodb/))
* [aws\_kms\_encrypt\_key](/docs/edge/reference/infrastructure-modules/aws/aws_kms_encrypt_key) (the encryption key using AWS [KMS](https://aws.amazon.com/kms/))
...
1. Open its directory in your terminal (for example, `$PF_ENVIRONMENTS_DIR/production`).
...
The first resource will be the [aws\_account](/docs/edge/reference/infrastructure-modules/aws/aws_account) module. This module adds some critical metadata
...
5. Run `sops -e -i secrets.yaml` to encrypt the file.
