...
`PF_ENVIRONMENTS_DIR` must be set up to follow [these conventions](/docs/edge/reference/configuration/terragrunt-variables).

We provide a convenience script for taking care of this bootstrapping: `pf-env-scaffold -e <env1,env2,...>`.
