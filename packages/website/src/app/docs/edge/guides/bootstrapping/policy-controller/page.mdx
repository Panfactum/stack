...
We provide a module for deploying Kyverno, [kube\_kyverno](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_kyverno).
...
[Kyverno Policies](https://kyverno.io/docs/kyverno-policies/), we provide a module called [kube\_policies](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_kyverno).
