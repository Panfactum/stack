...
We will use the [aws\_vpc](/docs/edge/reference/infrastructure-modules/direct/aws/aws_vpc) module to deploy the VPC.
...
See the [aws\_vpc](/docs/edge/reference/infrastructure-modules/direct/aws/aws_vpc) documentation for more details and to decide if it is right for you
(it probably is).
