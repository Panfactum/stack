...
[aws\_registered\_domains](/docs/edge/reference/infrastructure-modules/aws/aws_registered_domains) module. [^1]
...
[^1]: The domains will have the following defaults you can override if desired:
    ...
    refer to the [module documentation](/docs/edge/reference/infrastructure-modules/aws/aws_registered_domains).
...
[aws\_delegated\_zones](/docs/edge/reference/infrastructure-modules/aws/aws_delegated_zones) will provide the relevant setup
for this to work.
...
If you have static records to deploy, you can use our [aws\_dns\_records](/docs/edge/reference/infrastructure-modules/aws/aws_dns_records)
