...
We provide a module to deploy the operator: [kube\_cloudnative\_pg](/docs/edge/reference/infrastructure-modules/kubernetes/kube_cloudnative_pg).
...
3. Add a `module.yaml` that enables the `aws`, `helm`, `random`, and `kubernetes` providers.
...
We provide a module [kube\_pg\_cluster](/docs/edge/reference/infrastructure-modules/kubernetes/kube_pg_cluster) that you can use in your
projects to do this.
...
module called [test\_kube\_pg\_cluster](/docs/edge/reference/infrastructure-modules/kubernetes/kube_pg_cluster) which is a thin
wrapper around [kube\_pg\_cluster](/docs/edge/reference/infrastructure-modules/kubernetes/kube_pg_cluster).
...
3. Add a `module.yaml` that enables the `aws`, `helm`, `random`, `vault`, and `kubernetes` providers.
...
manner. Instead, you can run our [kube\_redis\_sentinel](/docs/edge/reference/infrastructure-modules/kubernetes/kube_redis_sentinel)
directly.
...
* **Relational:** PostgreSQL ([kube\_pg\_cluster](/docs/edge/reference/infrastructure-modules/kubernetes/kube_pg_cluster))
* **Key-value:** Redis ([kube\_redis\_sentinel](/docs/edge/reference/infrastructure-modules/kubernetes/kube_redis_sentinel))
...
<BootstrappingGuideNav backHref={"/docs/edge/guides/bootstrapping/maintenance-controllers"} forwardHref={"/docs/edge/guides/bootstrapping/identity-provider"} stepNumber={17} />
