...
<BootstrappingGuideNav backHref={"/docs/edge/guides/bootstrapping/maintenance-controllers"} forwardHref={"/docs/edge/guides/bootstrapping/identity-provider"} stepNumber={18} />
