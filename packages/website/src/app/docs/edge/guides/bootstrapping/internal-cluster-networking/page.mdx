...
Install the basic Kubernetes cluster networking primitives via the [kube\_core\_dns](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_core_dns)
and [kube\_cilium](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_cilium) modules.
...
for deploying Cilium: [kube\_cilium](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_cilium).
...
We provide a module to deploy CoreDNS called [kube\_core\_dns](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_core_dns).
...
6. If the deployment succeeds, you should see a `core-dns` deployment with either 1/2 or 2/2 pods running:
   ...
   you complete the [autoscaling section](/docs/edge/guides/bootstrapping/autoscaling) of the bootstrapping guide.
...
<BootstrappingGuideNav backHref={"/docs/edge/guides/bootstrapping/kubernetes-cluster"} forwardHref={"/docs/edge/guides/bootstrapping/policy-controller"} stepNumber={9} />
