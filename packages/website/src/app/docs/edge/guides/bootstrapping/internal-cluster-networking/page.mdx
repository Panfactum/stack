...
Install the basic kubernetes cluster networking primitives via the [kube\_core\_dns](/docs/edge/reference/infrastructure-modules/kubernetes/kube_core_dns)
and [kube\_cilium](/docs/edge/reference/infrastructure-modules/kubernetes/kube_cilium) modules.
...
We provide a module to deploy CoreDNS called [kube\_core\_dns](/docs/edge/reference/infrastructure-modules/kubernetes/kube_core_dns).
...
4. If you used our recommendation of `172.20.0.0/16` for the `service_cidr` in the [cluster setup docs](/docs/edge/guides/bootstrapping/kubernetes-cluster#choose-a-service-cidr),
