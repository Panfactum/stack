...
* using a [Panfacutm module](/docs/edge/guides/iac/panfactum-modules)

* using a [first-party module](/docs/edge/guides/iac/first-party-modules) (defined in your infrastructure repo)
...
We provide ready-made configuration for many providers (see the [full list here](/docs/edge/reference/configuration/terragrunt-variables)).
...
configuration variables, see the [reference docs](/docs/edge/reference/configuration/terragrunt-variables).
