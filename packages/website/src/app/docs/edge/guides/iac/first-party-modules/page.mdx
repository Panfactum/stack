...
* The [configuration-as-code](/docs/edge/concepts/iac#configuration-as-code) (e.g., module versions, module inputs, etc.) will **always** be defined
...
[standard inputs](/docs/edge/reference/infrastructure-modules/overview#standard-variables)
...
We provide a [templating system](/docs/edge/reference/iac-templating#standard-vars) to make maintaining these
variables easier.
...
[standard inputs](/docs/edge/reference/infrastructure-modules/overview#standard-variables). We
use [templating system](/docs/edge/reference/iac-templating#standard-vars) to make maintaining
these calling conventions easier:

1. Add a [template directive](/docs/edge/reference/iac-templating#directives) to the module:
...
1. Append `# pf-update` to the `module.source` line:
   ...
   ```hcl
   module "pod" {
     source       = "github.com/Panfactum/stack.git//packages/infrastructure/kube_pod?ref=__PANFACTUM_VERSION_EDGE__" # pf-update
   }
   ```
