...
This module is intended to be used in conjunction with the [kube\_ingress](/docs/edge/reference/infrastructure-modules/submodule/kubernetes/kube\_ingress)
