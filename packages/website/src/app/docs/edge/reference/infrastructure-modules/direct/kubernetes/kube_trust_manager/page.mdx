...
<ModuleHeader name="kube_trust_manager" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_trust_manager" status="deprecated" type="direct" />
