...
- `aws_cdn` ([docs](/docs/edge/reference/infrastructure-modules/submodule/aws/aws\_cdn)); or
- `aws_s3_private_bucket` ([docs](/docs/edge/reference/infrastructure-modules/submodule/aws/aws\_s3\_private\_bucket))
