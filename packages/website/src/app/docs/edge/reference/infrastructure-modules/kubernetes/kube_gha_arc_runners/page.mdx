...
<ModuleHeader name="kube_gha_arc_runners" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_gha_arc_runners" status="alpha" type="live" />
