...
<ModuleHeader name="kube_priority_classes" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_priority_classes" status="deprecated" type="direct"/>
