...
<ModuleHeader name="kube_canary" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_canary" status="alpha" type="live" />
