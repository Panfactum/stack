...
<ModuleHeader name="kube_external_dns" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_external_dns" status="stable" type="live" />
