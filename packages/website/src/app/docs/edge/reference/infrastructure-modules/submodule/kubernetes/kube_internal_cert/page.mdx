...
<ModuleHeader name="kube_internal_cert" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_internal_cert" status="stable" type="submodule" />
