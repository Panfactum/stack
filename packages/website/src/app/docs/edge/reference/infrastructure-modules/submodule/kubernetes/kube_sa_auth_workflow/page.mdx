...
<ModuleHeader name="kube_sa_auth_workflow" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_sa_auth_workflow" status="alpha" type="submodule" />
