...
<ModuleHeader name="aws_delegated_zones" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/aws_delegated_zones" status="stable" type="live" />
