...
<ModuleHeader name="test_kube_pg_cluster" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/test_kube_pg_cluster" status="stable" type="direct" />
