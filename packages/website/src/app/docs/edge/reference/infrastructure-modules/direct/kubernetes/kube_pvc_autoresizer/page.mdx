...
<ModuleHeader name="kube_pvc_autoresizer" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_pvc_autoresizer" status="stable" type="direct" />
