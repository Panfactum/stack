...
<ModuleHeader name="kube_fledged" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_fledged" status="stable" type="direct" />
