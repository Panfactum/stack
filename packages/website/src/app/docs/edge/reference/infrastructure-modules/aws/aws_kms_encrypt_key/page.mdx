...
<ModuleHeader name="aws_kms_encrypt_key" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/aws_kms_encrypt_key" status="stable" type="submodule" />
