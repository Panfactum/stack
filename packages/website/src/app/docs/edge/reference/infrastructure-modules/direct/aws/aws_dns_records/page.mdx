...
<ModuleHeader name="aws_dns_records" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/aws_dns_records" status="stable" type="direct" />
