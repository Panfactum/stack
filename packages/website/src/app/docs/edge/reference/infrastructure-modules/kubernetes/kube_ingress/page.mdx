...
<ModuleHeader name="kube_ingress" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/kube_ingress" status="stable" type="submodule" />
...
### <a name="input_cors_extra_allowed_headers" /> [cors\_extra\_allowed\_headers](#input_cors_extra_allowed_headers)
