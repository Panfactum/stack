...
<ModuleHeader name="kube_descheduler" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_descheduler" status="stable" type="live" />
