...
<ModuleHeader name="kube_descheduler" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/kube_descheduler" status="stable" type="live" />
