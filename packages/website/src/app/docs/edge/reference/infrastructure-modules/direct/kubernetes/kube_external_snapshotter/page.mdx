...
<ModuleHeader name="kube_external_snapshotter" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_external_snapshotter" status="stable" type="direct" />
