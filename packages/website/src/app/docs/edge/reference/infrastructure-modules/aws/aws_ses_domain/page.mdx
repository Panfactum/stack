...
<ModuleHeader name="aws_ses_domain" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/aws_ses_domain" status="stable" type="live" />
