...
<ModuleHeader name="kube_workflow" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_workflow" status="alpha" type="submodule" />
