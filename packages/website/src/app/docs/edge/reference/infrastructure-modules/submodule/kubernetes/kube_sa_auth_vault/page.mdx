...
<ModuleHeader name="kube_sa_auth_vault" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_sa_auth_vault" status="stable" type="submodule"/>
