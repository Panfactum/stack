...
<ModuleHeader name="kube_gha_arc_systems" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/kube_gha_arc_systems" status="alpha" type="live" />
