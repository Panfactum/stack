...
<ModuleHeader name="aws_ecr_public_repos" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/aws_ecr_public_repos" status="stable" type="direct" />
...
### <a name="output_ecr_repositories" /> [ecr\_repositories](#output_ecr_repositories)
