...
<ModuleHeader name="authentik_zoho_sso" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/authentik_zoho_sso" status="stable" type="live" />
