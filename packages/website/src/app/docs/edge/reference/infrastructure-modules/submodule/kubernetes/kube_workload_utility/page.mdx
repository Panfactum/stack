...
<ModuleHeader name="kube_workload_utility" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_workload_utility" status="stable" type="submodule" />
