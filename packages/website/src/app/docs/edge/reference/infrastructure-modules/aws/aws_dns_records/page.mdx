...
<ModuleHeader name="aws_dns_records" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/aws_dns_records" status="stable" type="live" />
