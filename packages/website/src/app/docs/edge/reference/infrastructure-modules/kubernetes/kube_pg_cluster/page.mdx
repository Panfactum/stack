...
### <a name="input_pg_bouncer_read_only_enabled" /> [pg\_bouncer\_read\_only\_enabled](#input_pg_bouncer_read_only_enabled)
...
### <a name="input_pg_bouncer_read_write_enabled" /> [pg\_bouncer\_read\_write\_enabled](#input_pg_bouncer_read_write_enabled)
