...
```hcl
module "database" {
  source = "github.com/Panfactum/stack.git//packages/infrastructure/kube_pg_cluster?ref=__PANFACTUM_VERSION_EDGE__" # pf-update
  ...
}
...
### <a name="input_backups_retention_days" /> [backups\_retention\_days](#input_backups_retention_days)
...
### <a name="input_pg_recovery_directory" /> [pg\_recovery\_directory](#input_pg_recovery_directory)
...
### <a name="input_pg_recovery_mode_enabled" /> [pg\_recovery\_mode\_enabled](#input_pg_recovery_mode_enabled)
...
### <a name="input_pg_recovery_target_time" /> [pg\_recovery\_target\_time](#input_pg_recovery_target_time)
...
### <a name="input_pg_sync_replication_enabled" /> [pg\_sync\_replication\_enabled](#input_pg_sync_replication_enabled)
...
### <a name="input_vault_credential_lifetime_hours" /> [vault\_credential\_lifetime\_hours](#input_vault_credential_lifetime_hours)
...
### <a name="output_admin_creds_secret" /> [admin\_creds\_secret](#output_admin_creds_secret)
...
### <a name="output_reader_creds_secret" /> [reader\_creds\_secret](#output_reader_creds_secret)

Description: The name of the Kubernetes Secret holding credentials for the reader role in the PostgreSQL database

### <a name="output_recovery_directory" /> [recovery\_directory](#output_recovery_directory)
...
### <a name="output_root_password" /> [root\_password](#output_root_password)

Description: The password for root user of the database

### <a name="output_root_username" /> [root\_username](#output_root_username)
...
### <a name="output_superuser_creds_secret" /> [superuser\_creds\_secret](#output_superuser_creds_secret)
