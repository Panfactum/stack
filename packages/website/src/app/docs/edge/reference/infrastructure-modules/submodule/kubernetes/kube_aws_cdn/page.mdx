...
<ModuleHeader name="kube_aws_cdn" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_aws_cdn" status="beta" type="submodule"/>
...
output from instances of the [kube\_ingress](/docs/edge/reference/infrastructure-modules/submodule/kubernetes/kube\_ingress)
module and forwarding them to the [aws\_cdn](/docs/edge/reference/infrastructure-modules/submodule/aws/aws\_cdn) module.

This module takes the same arguments as `aws_cdn`, so see it's [module documentation](/docs/edge/reference/infrastructure-modules/submodule/aws/aws\_cdn)
...
* For additional limitations, see the [aws\_cdn](/docs/edge/reference/infrastructure-modules/submodule/aws/aws\_cdn) module docs.
