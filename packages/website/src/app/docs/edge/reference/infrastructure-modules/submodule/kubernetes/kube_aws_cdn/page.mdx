...
output from instances of the [kube\_ingress](/docs/edge/reference/infrastructure-modules/submodule/kubernetes/kube_ingress)
module and forwarding them to the [aws\_cdn](/docs/edge/reference/infrastructure-modules/submodule/aws/aws_cdn) module.
...
* For additional limitations, see the [aws\_cdn](/docs/edge/reference/infrastructure-modules/submodule/aws/aws_cdn) module docs.
