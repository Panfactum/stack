...
<ModuleHeader name="kube_aws_ebs_csi" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/kube_aws_ebs_csi" status="stable" type="live" />
