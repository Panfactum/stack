...
<ModuleHeader name="kube_buildkit" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_buildkit" status="alpha" type="direct" />
