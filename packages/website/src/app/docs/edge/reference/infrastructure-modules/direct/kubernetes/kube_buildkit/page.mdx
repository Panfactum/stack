...
<ModuleHeader name="kube_buildkit" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_buildkit" status="beta" type="direct" />
...
### <a name="input_cache_clear_cron" /> [cache\_clear\_cron](#input_cache_clear_cron)
...
### <a name="output_ecr_registry" /> [ecr\_registry](#output_ecr_registry)

Description: n/a

### <a name="output_eks_cluster_name" /> [eks\_cluster\_name](#output_eks_cluster_name)
