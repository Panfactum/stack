...
<ModuleHeader name="kube_gha_runners" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_gha_runners" status="beta" type="direct" />
...
### <a name="input_github_token" /> [github\_token](#input_github_token)

Description: The GitHub token that the runners will use to register with GitHub

Type: `string`

### <a name="input_runners" /> [runners](#input_runners)
...
### <a name="input_gha_runner_scale_set_helm_version" /> [gha\_runner\_scale\_set\_helm\_version](#input_gha_runner_scale_set_helm_version)
