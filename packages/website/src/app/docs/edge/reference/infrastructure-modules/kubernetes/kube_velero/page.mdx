...
<ModuleHeader name="kube_velero" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_velero" status="stable" type="live" />
