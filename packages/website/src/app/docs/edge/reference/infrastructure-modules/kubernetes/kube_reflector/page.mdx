...
<ModuleHeader name="kube_reflector" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_reflector" status="stable" type="live" />
