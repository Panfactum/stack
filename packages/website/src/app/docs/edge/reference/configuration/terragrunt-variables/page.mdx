...
Your environments folder at `$PF_ENVIRONMENTS_DIR` **must** have three levels of scoping for the [configuration-as-code](/docs/edge/concepts/iac#configuration-as-code):
