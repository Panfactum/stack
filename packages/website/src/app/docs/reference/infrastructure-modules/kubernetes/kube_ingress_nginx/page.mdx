...
<ModuleHeader name="kube_ingress_nginx" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/kube_ingress_nginx" status="stable" type="live" />
