...
<ModuleHeader name="kube_trust_manager" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/kube_trust_manager" status="stable" type="live" />
