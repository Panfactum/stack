...
<ModuleHeader name="kube_cloudnative_pg" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/kube_cloudnative_pg" status="stable" type="live" />
