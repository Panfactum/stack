...
<ModuleHeader name="aws_ecr_pull_through_cache" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/aws_ecr_pull_through_cache" status="stable" type="live" />
