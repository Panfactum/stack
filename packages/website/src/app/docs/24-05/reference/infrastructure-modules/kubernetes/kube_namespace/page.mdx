...
<ModuleHeader name="kube_namespace" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/kube_namespace" status="stable" type="submodule" />
