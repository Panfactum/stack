...
<ModuleHeader name="kube_sa_auth_aws" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/kube_sa_auth_aws" status="stable" type="submodule" />
...
assigned in the [aws\_vpc](/docs/24-05/reference/infrastructure-modules/aws/aws_vpc) and [aws\_eks](/docs/24-05/reference/infrastructure-modules/aws/aws_eks)
