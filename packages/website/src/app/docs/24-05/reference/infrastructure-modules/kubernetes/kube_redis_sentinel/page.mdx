...
<ModuleHeader name="kube_redis_sentinel" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/kube_redis_sentinel" status="stable" type="submodule" />
