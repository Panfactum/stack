...
<ModuleHeader name="aws_eks" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/aws_eks" status="stable" type="live" />
...
* A set of controller [node groups](https://docs.aws.amazon.com/eks/latest/userguide/managed-node-groups.html)
  ...
  Autoscaled nodes are deployed via our [kube\_karpenter](/docs/24-05/reference/infrastructure-modules/kubernetes/kube_karpenter) module.
