...
<ModuleHeader name="kube_cert_manager" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/kube_cert_manager" status="stable" type="live" />
