...
<ModuleHeader name="test_kube_pg_cluster" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/test_kube_pg_cluster" status="stable" type="live" />

Used in the [bootstrapping guide](/docs/24-05/guides/bootstrapping/databases) to demonstrate the capabilities of the PostgreSQL cluster.
