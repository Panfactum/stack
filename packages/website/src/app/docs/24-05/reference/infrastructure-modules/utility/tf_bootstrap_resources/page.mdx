...
<ModuleHeader name="tf_bootstrap_resources" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/tf_bootstrap_resources" status="stable" type="live" />
