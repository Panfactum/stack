...
<ModuleHeader name="kube_sa_auth_pg" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/kube_sa_auth_pg" status="stable" type="submodule" />
