...
<ModuleHeader name="authentik_aws_sso" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/authentik_aws_sso" status="stable" type="live" />
