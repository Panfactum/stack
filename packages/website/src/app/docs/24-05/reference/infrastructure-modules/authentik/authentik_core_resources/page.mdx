...
<ModuleHeader name="authentik_core_resources" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/authentik_core_resources" status="stable" type="live" />
