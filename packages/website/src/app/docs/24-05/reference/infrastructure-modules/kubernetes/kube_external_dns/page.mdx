...
<ModuleHeader name="kube_external_dns" sourceHref="https://github.com/Panfactum/stack/tree/main/packages/infrastructure/kube_external_dns" status="stable" type="live" />
