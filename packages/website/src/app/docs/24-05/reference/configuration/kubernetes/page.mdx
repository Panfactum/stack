...
[Example File](https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_24_05__/packages/reference/.kube/config.yaml)
...
| -------- | ------------------------------------------------------------------------------------------- | -------------------- |
| `module` | The path to the `aws_eks` module deployment relative to the `PF_ENVIRONMENTS_DIR` directory | `env/region/aws_eks` |

## config.user.yaml

[Example File](https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_24_05__/packages/reference/.kube/config.user.yaml)
...
| Value         | Description                                                                                                    | Example                |
| ------------- | -------------------------------------------------------------------------------------------------------------- | ---------------------- |
| `name`        | The name of the cluster. The full list of available cluster names can be found in `$PF_KUBE_DIR/cluster_info`. | `production-primary`   |
| `aws_profile` | The AWS profile to use to authenticate with the cluster. Must be a valid profile in `$PF_AWS_DIR/config`.      | `production-superuser` |

## cluster\_info

[Example File](https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_24_05__/packages/reference/.kube/cluster_info)
