...
These are the default groups provisioned by the [authentik\_core\_resources](/docs/24-05/reference/infrastructure-modules/authentik/authentik_core_resources). **These
are global.**
