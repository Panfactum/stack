...
If you are deploying Panfactum terraform modules directly, update the `pf_stack_version` [terragrunt variable](/docs/24-05/reference/configuration/terragrunt-variables).
