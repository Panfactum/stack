...
- shared: Set up in the repo's `devenv.nix` by your organization's administrators ([docs](/docs/24-05/reference/configuration/repo-variables))
- personal: Unique to you and set up in a top-level `.env` file ([docs](/docs/24-05/reference/configuration/dotenv))
...
For the complete list of values, see the Panfactum [reference docs](/docs/24-05/reference/configuration/dotenv).
...
<MarkdownGuideNav backHref={"/docs/24-05/guides/getting-started/install-tooling"} forwardHref={"/docs/24-05/guides/getting-started/connect-to-infrastructure"} stepNumber={3} totalSteps={4} progressLabel={"Getting Started Guide:"} />
