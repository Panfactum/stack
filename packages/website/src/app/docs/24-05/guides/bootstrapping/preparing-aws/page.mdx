...
5. Open your [stack repo](/docs/24-05/guides/bootstrapping/installing-devenv) locally. We will be setting up your [AWS configuration and
   credentials](https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-files.html) files in your `PF_AWS_DIR` directory ([reference](/docs/24-05/reference/configuration/repo-variables))
   ...
   1. Run `pf-update-aws` to set up this directory.
...
<BootstrappingGuideNav backHref={"/docs/24-05/guides/bootstrapping/installing-devenv"} forwardHref={"/docs/24-05/guides/bootstrapping/configuring-infrastructure-as-code"} stepNumber={3} />
