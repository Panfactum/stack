...
using our [aws\_eks](/docs/24-05/reference/infrastructure-modules/aws/aws_eks) module.
...
We provide a module for configuring this behavior: [aws\_ecr\_pull\_through\_cache](/docs/24-05/reference/infrastructure-modules/aws/aws_ecr_pull_through_cache).
...
3. Add a `terragrunt.hcl` to that directory that looks like [this](https://github.com/Panfactum/stack/blob/__PANFACTUM_VERSION_24_05__/packages/reference/environments/production/us-east-2/aws_ecr_pull_through_cache/terragrunt.hcl).
...
3. Add a `terragrunt.hcl` to that directory that looks like [this](https://github.com/Panfactum/stack/blob/__PANFACTUM_VERSION_24_05__/packages/reference/environments/production/us-east-2/aws_eks/terragrunt.hcl).
...
with the rest of the Panfactum stack. See the [module documentation](/docs/24-05/reference/infrastructure-modules/aws/aws_eks) if
...
you created in the [aws networking guide](/docs/24-05/guides/bootstrapping/aws-networking). [^3] This ensures the API server is resilient to an AZ outage.
...
information about this file can be found [here](/docs/24-05/reference/configuration/kubernetes).
...
<MarkdownAlert severity="warning">
  *Every* one of your users will need to set up their own `config.user.yaml` file, and we provide instructions
  for them [here](/docs/24-05/guides/getting-started/connect-to-infrastructure).
</MarkdownAlert>
...
some additional [terragrunt variables](/docs/24-05/reference/configuration/terragrunt-variables).
...
See [this file](https://github.com/Panfactum/stack/blob/__PANFACTUM_VERSION_24_05__/packages/reference/environments/production/us-east-2/region.yaml) as an example.
...
the cluster automatically has cluster access). We will now deploy the [kube\_rbac](/docs/24-05/reference/infrastructure-modules/kubernetes/kube_rbac)
...
2. Set up a `terragunt.hcl` that looks like [this](https://github.com/Panfactum/stack/blob/__PANFACTUM_VERSION_24_05__/packages/reference/environments/production/us-east-2/kube_rbac/terragrunt.hcl).
...
as an unexpected AZ outage. These are defined in the [kube\_priority\_classes](/docs/24-05/reference/infrastructure-modules/kubernetes/kube_priority_classes)
module.
...
2. Set up a `terragunt.hcl` that looks like [this](https://github.com/Panfactum/stack/blob/__PANFACTUM_VERSION_24_05__/packages/reference/environments/production/us-east-2/kube_priority_classes/terragrunt.hcl).
...
<BootstrappingGuideNav backHref={"/docs/24-05/guides/bootstrapping/aws-networking"} forwardHref={"/docs/24-05/guides/bootstrapping/internal-cluster-networking"} stepNumber={8} />
