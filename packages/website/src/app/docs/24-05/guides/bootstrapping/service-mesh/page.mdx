...
check out our [concept documentation.](/docs/24-05/concepts/networking/cluster-networking#service-mesh)

## Deploy Linkerd2

[Linkerd](https://linkerd.io/2.15/overview/) is likely the most popular service mesh for Kubernetes,
and we provide a module for deploying it: [kube\_linkerd](/docs/24-05/reference/infrastructure-modules/kubernetes/kube_linkerd)
...
2. Add a `terragrunt.hcl` to that directory that looks like [this](https://github.com/Panfactum/stack/blob/__PANFACTUM_VERSION_24_05__/packages/reference/environments/production/us-east-2/kube_linkerd/terragrunt.hcl).
...
<BootstrappingGuideNav backHref={"/docs/24-05/guides/bootstrapping/certificate-management"} forwardHref={"/docs/24-05/guides/bootstrapping/autoscaling"} stepNumber={13} />
