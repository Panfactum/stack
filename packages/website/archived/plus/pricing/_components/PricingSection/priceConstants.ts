...
export const STACK_UTILIZATION_RATE = 50;
...
export const ACCESS_MANAGEMENT_HOURS_PER_EMPLOYEE = 0.25;
export const ACCESS_MANAGEMENT_HOURS_PER_DEVELOPER = 1;
...
// Labor costs
export const LABOR_HOURS_PER_CLUSTER = 22;
export const LABOR_HOURS_PER_CUSTOM_WORKLOAD = 9;
export const LABOR_HOURS_PER_DB_WORKLOAD = 5;
export const LABOR_HOURS_PER_STANDARD_MODULE = 2;
...
export const CLUSTER_LIST_PRICE = 699
export const CUSTOM_WORKLOAD_DEPLOYMENT_LIST_PRICE=229
export const DATABASE_DEPLOYMENT_LIST_PRICE = 149
export const MODULE_DEPLOYMENT_LIST_PRICE = 69
export const CLUSTER_COST = CLUSTER_LIST_PRICE  / (1+ANNUAL_SPEND_DISCOUNT_MULTIPLIER + STARTUP_DISCOUNT_MULTIPLIER);
export const CUSTOM_WORKLOAD_DEPLOYMENT_COST = CUSTOM_WORKLOAD_DEPLOYMENT_LIST_PRICE  / (1+ANNUAL_SPEND_DISCOUNT_MULTIPLIER + STARTUP_DISCOUNT_MULTIPLIER);
export const DATABASE_DEPLOYMENT_COST = DATABASE_DEPLOYMENT_LIST_PRICE / (1 + ANNUAL_SPEND_DISCOUNT_MULTIPLIER + STARTUP_DISCOUNT_MULTIPLIER);
export const MODULE_DEPLOYMENT_COST = MODULE_DEPLOYMENT_LIST_PRICE / (1 + ANNUAL_SPEND_DISCOUNT_MULTIPLIER + STARTUP_DISCOUNT_MULTIPLIER);
...
export const FLAT_RATE_PRICE = 999 / (1 + ANNUAL_SPEND_DISCOUNT_MULTIPLIER);
