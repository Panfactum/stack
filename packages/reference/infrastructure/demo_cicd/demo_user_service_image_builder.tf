module "demo_user_service_builder" {
...
module "build_and_deploy_demo_user_service_workflow" {
  ...
  passthrough_parameters = [
    ...
    {
      name = "tf_apply_dir"
      value = "packages/reference/environments/production/us-east-2/demo_user_service"
    }
  ]
        ...
        tasks = [
          {
            name = "build-image"
            templateRef = {
              name = module.demo_user_service_builder.name
              template = module.demo_user_service_builder.entrypoint
            }
          },
          {
            name = "deploy-image"
...
resource "kubectl_manifest" "build_and_deploy_demo_user_service_workflow_template" {
  yaml_body = yamlencode({
    ...
    metadata = {
      ...
      namespace = local.namespace
      labels = module.build_and_deploy_demo_user_service_workflow.labels
    }
    spec = module.build_and_deploy_demo_user_service_workflow.workflow_spec
  })
