module "demo_python_service_builder" {
  ...
  dockerfile_path = "./packages/reference/services/demo-python-service/Containerfile"
  build_context = "./packages/reference/services/demo-python-service"
...
module "build_and_deploy_demo_python_service_workflow" {
  ...
  passthrough_parameters = [
    ...
    {
      name = "tf_apply_dir"
      value = "packages/reference/environments/production/us-east-2/demo_python_service"
    }
  ]
