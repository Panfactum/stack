  ...
  "flex gap-lg items-center text-sm px-[16px] border-l-4 mb-4",
  {
    variants: {
      severity: {
        ...
        warning:
          "bg-warning-primary dark:bg-brand-docs-warning border-warning text-foreground",
        error:
          "bg-error-primary dark:bg-brand-docs-error border-error text-foreground",
        success:
          "bg-success-primary dark:bg-brand-docs-success border-success text-foreground",
      },
    },
    defaultVariants: {
      severity: "info",
