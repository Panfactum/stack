...
import { isSearchModalOpen } from "./SearchDialogState";
        ...
        <div class="fixed left-0 top-0 z-[100] w-screen max-w-[100vw]">
          <Dialog.Content class="relative left-[calc(100%_/_12)] top-16 w-5/6 max-w-5/6 sm:left-[calc(100%_/_8)] sm:w-3/4 md:left-1/5 md:w-3/5 lg:left-1/4 lg:w-1/2">
            ...
            <TextField
              ...
              value={query()}
              onChange={setQuery}
              class="bg-primary flex h-12 w-full items-center overflow-hidden rounded-md pr-4 focus-within:shadow-lg dark:bg-[#1f2428]"
            >
              ...
              <TextField.Input
                ref={setInputEl}
                id="search"
                class="bg-primary  size-full border-0 pr-8 text-sm outline-none focus:border-0 focus:ring-0 dark:bg-[#1f2428]"
                autocomplete="off"
                role="searchbox"
              />
              <Show when={query()}>
            ...
            <div
              class={
                "bg-primary mt-4 flex flex-col rounded-sm px-8 py-4 dark:bg-[#1f2428]"
              }
            >
