---
title: 'Installing the Development Shell'
---
...
<MarkdownAlert severity="info">
  We provide a [reference repository
  setup](https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/reference)
  that you can benchmark against as you progress through the setup
  documentation.
</MarkdownAlert>
...
<MarkdownAlert severity="warning">
  On the first install, this can take a few minutes to build the entire devShell
  as it contains multiple gigabytes of tooling. This is especially slow on macOS
  and can take up to 10 minutes to complete.
</MarkdownAlert>
...
this repository over _HTTPS_ (not SSH). As result, you will need to set up the HTTPS credentials required
