...
<MarkdownAlert severity="warning">
  We only support upgrading to the next major version in sequence. For example,
  if there exists the versions `24-01.1`, `24-07.1`, and `25-01.1`, and you are
  currently using version `24-01.1`, you MUST first upgrade to version `24-07.1`
