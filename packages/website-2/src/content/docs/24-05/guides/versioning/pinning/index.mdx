---
title: 'Pinning the Panfactum Version'
---
...
If you are deploying Panfactum IaC modules, update the `pf_stack_version` [terragrunt variable](/docs/edge/reference/configuration/terragrunt-variables).
