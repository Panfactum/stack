---
title: 'Argo Workflow Template: Tofu Deployment'
---
...
<ModuleHeader
  name="wf_tf_deploy"
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/wf_tf_deploy"
  status="beta"
  type="submodule"
/>
