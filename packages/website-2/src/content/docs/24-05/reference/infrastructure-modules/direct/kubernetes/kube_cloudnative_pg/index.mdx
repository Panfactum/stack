---
title: 'Kubernetes Cloud Native Postgres'
---
...
<ModuleHeader
  ...
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_cloudnative_pg"
  status="stable"
  type="direct"
/>
