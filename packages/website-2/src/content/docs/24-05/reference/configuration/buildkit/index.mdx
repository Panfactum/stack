---
title: 'BuildKit Configuration Files'
---
...
x
[Example File](https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/reference/.buildkit/config.yaml)
