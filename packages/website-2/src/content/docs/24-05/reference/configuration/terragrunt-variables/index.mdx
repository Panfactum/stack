...
<MarkdownAlert severity="info">
  For a complete example, see [our reference
  architecture](https://github.com/Panfactum/stack/tree/main/packages/reference/environments).
</MarkdownAlert>
...
_Note: The `aws` provider is actually a set of two different `aws` provider configurations: a primary and secondary.
The secondary is used in some Panfactum modules to configure things like backups in a secondary region._
