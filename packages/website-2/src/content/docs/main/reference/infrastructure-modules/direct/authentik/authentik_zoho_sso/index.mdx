...
<ModuleHeader
  name="authentik_zoho_sso"
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/authentik_zoho_sso"
  status="stable"
  type="direct"
/>
