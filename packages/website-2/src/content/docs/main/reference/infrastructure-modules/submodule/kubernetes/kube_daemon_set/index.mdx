...
<ModuleHeader name="kube_daemon_set" sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_MAIN__/packages/infrastructure/kube_daemon_set" status="stable" type="submodule" />
