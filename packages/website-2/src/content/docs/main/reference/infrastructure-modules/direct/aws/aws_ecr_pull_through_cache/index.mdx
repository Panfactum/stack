---
title: 'AWS ECR Pull Through Cache'
---
...
<ModuleHeader
  ...
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/aws_ecr_pull_through_cache"
  status="stable"
  type="direct"
/>
