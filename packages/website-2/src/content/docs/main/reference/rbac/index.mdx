...
These are the default groups provisioned by the [authentik_core_resources](/docs/edge/reference/infrastructure-modules/direct/authentik/authentik_core_resources). **These
are global.**

The below table charts their _recommended_ role by environment; however, by default they do not confer any permissions as this depends
