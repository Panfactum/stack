...
[^1]:
    This type of storage should be considered ephemeral (temporary) as it inherently linked to the lifetime of the underlying
...
We provide the [kube_aws_ebs_csi](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_aws_ebs_csi) module to deploy the driver.
...
5. Verify the pods deployed successfully:
   <Image src={ebsCSILaunchImg} alt="AWS EBS CSI launched successfully" />
...
<Image src={storageClassesImg} alt="Storage classes in the cluster" />
