---
title: "Building Images with BuildKit"
---
...
[^1]:
    Even though we do not recommend using the [Docker Engine](https://docs.docker.com/engine/), we still use conventions from the Docker ecosystem
...
<MarkdownAlert severity="info">
  As you review the best ways to construct your images and build processes, it
  may be helpful to review the overall BuildKit [architecture
  documentation](/docs/edge/concepts/buildkit#architecture) to gain a better
...
We recommend using the [Google's hardned "Distroless" images](https://github.com/GoogleContainerTools/distroless) as base
