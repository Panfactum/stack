---
title: "Developing First-party Modules"
---
...
<ImageSvg src={VersioningImg} alt="Terragrunt module versioning diagram" />
...
[^1]:
    For example, you should not run a submodule version `edge.24-10-09` when the cluster is running
    `edge.24-11-24`.
...
Often you want to know _exactly_ what code is deployed in an environment at any given time. Git refs like branch
