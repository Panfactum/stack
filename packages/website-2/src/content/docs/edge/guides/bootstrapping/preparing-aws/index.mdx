...
5. Open your [stack repo](/docs/main/guides/bootstrapping/installing-devshell) locally. We will be setting up your [AWS configuration and
...
<BootstrappingGuideNav backHref={"/docs/main/guides/bootstrapping/installing-devshell"} forwardHref={"/docs/main/guides/bootstrapping/configuring-infrastructure-as-code"} stepNumber={3} />
