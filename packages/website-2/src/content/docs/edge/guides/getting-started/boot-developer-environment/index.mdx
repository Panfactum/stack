---
title: 'Boot Developer Environment'
---
...
1. Download your organization's `git` repository that contains your infrastructure code.
   ...
   [^2]:
       If you are trying to connect to the [demo environment](/stack/demo/live), download the [stack repository](https://github.com/Panfactum/stack)
