---
title: "Kubernetes Node Image Cache"
---
...
<ModuleHeader
  ...
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_node_image_cache"
  status="stable"
  type="submodule"
/>
...
The [kube_node_image_cache_controller](/docs/edge/reference/infrastructure-modules/direct/kubernetes/kube_node_image_cache_controller) must be installed in order for this to work.
