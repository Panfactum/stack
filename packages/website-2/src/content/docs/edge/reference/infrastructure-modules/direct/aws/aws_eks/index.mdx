...
by the `vpc_id` input as these are the subnets created by the [aws\_vpc](/docs/main/reference/infrastructure-modules/direct/aws/aws_vpc) module.
...
The SSO roles are installed into each account via [aws\_iam\_identity\_center\_permissions](/docs/main/reference/infrastructure-modules/direct/aws/aws_iam_identity_center_permissions)
...
in the [kube\_policies](/docs/main/reference/infrastructure-modules/direct/kubernetes/kube_policies). AWS doesn't install
