...
images to the cache by leveraging the [kube\_node\_image\_cache](/docs/main/reference/infrastructure-modules/submodule/kubernetes/kube_node_image_cache) submodule.
