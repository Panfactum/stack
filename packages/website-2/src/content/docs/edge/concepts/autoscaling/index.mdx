...
import ScheduleConstraintImg from "./schedule-constraint.png";
import MarkdownImg from "@/components/astro/markdown/MarkdownImage.astro";
...
<MarkdownImg
  src={ScheduleConstraintImg}
  alt="Impact of scheduling constraints"
/>
