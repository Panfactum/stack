...
export const CUSTOM_WORKLOAD_DEPLOYMENT_COST = 279  / (1-PRIORITY_SUPPORT_MULTIPLIER);
export const DATABASE_DEPLOYMENT_COST = 179 / (1 - PRIORITY_SUPPORT_MULTIPLIER);
export const MODULE_DEPLOYMENT_COST = 79 / (1 - PRIORITY_SUPPORT_MULTIPLIER);
