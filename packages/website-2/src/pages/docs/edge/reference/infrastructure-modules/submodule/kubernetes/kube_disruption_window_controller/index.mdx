...
title: 'Disruption Window Controller'
---
...
<ModuleHeader
  ...
  sourceHref="https://github.com/Panfactum/stack/tree/__PANFACTUM_VERSION_EDGE__/packages/infrastructure/kube_disruption_window_controller"
  status="stable"
  type="submodule"
/>
...
referred to as the _disruption window._

There may be many instances of this submodule running in the cluster and each is namespace-scoped. For example,
we make use of this submodule in our database modules (e.g., [kube_pg_cluster](/docs/edge/reference/infrastructure-modules/submodule/kubernetes/kube_pg_cluster)).
