...
import PriceDetailsTableRow from "@/pages/support/_components/solid/PriceCalculator/PriceDetailsTableRow.tsx";
  ...
  return (
    ...
    >
      <div class="flex w-full max-w-screen-md flex-col items-center gap-4 lg:max-w-screen-xl">
        ...
        <p class="self-start text-xs">
          <em>
            Cloud Foundations is the base cost that we charge to configure and
            production-harden your cloud environment and source control systems
            to begin deploying cloud infrastructure.
          </em>
        </p>
      </div>
    </Modal>
