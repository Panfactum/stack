...
import { Separator } from "@/components/react/ui/separator.tsx";
import { Sheet, SheetContent, SheetTitle } from "@/components/react/ui/sheet.tsx";
import { Skeleton } from "@/components/react/ui/skeleton.tsx";
        ...
        <>
          ...
          >
            <SheetContent
              ...
              data-mobile="true"
              className="w-[--sidebar-width] bg-primary p-0 [&>button]:hidden"
              style={
                {
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col gap-y-3xl bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none transition-[width,height,padding] focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:font-medium group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "hover:bg-accent dark:hover:bg-accent-dark",
      },
      size: {
      ...
      isActive: {
        true: "bg-accent-dark font-semibold",
        false: "",
      },
    },
    defaultVariants: {
...
const SidebarMenuButtonTreeItem = React.forwardRef<
  ...
  React.ComponentProps<"button"> & {
    asChild?: boolean;
    isActive?: boolean;
  } & VariantProps<typeof sidebarMenuButtonVariantsTreeItem>
>(
  (
    {
      asChild = false,
