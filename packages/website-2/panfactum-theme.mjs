export const theme = {
  colors: {
    ...
    gray: {
      ...
      "gray-blue": {
        25: "var(--colors-gray-gray-blue-25)",
        50: "var(--colors-gray-gray-blue-50)",
        100: "var(--colors-gray-gray-blue-100)",
        200: "var(--colors-gray-gray-blue-200)",
        300: "var(--colors-gray-gray-blue-300)",
        400: "var(--colors-gray-gray-blue-400)",
        500: "var(--colors-gray-gray-blue-500)",
        600: "var(--colors-gray-gray-blue-600)",
        700: "var(--colors-gray-gray-blue-700)",
        800: "var(--colors-gray-gray-blue-800)",
        900: "var(--colors-gray-gray-blue-900)",
        950: "var(--colors-gray-gray-blue-950)",
      },
      "gray-cool": {
        25: "var(--colors-gray-gray-cool-25)",
        50: "var(--colors-gray-gray-cool-50)",
        100: "var(--colors-gray-gray-cool-100)",
        200: "var(--colors-gray-gray-cool-200)",
        300: "var(--colors-gray-gray-cool-300)",
        400: "var(--colors-gray-gray-cool-400)",
        500: "var(--colors-gray-gray-cool-500)",
        600: "var(--colors-gray-gray-cool-600)",
        700: "var(--colors-gray-gray-cool-700)",
        800: "var(--colors-gray-gray-cool-800)",
        900: "var(--colors-gray-gray-cool-900)",
        950: "var(--colors-gray-gray-cool-950)",
      },
      "gray-warm": {
        25: "var(--colors-gray-gray-warm-25)",
        50: "var(--colors-gray-gray-warm-50)",
        100: "var(--colors-gray-gray-warm-100)",
        200: "var(--colors-gray-gray-warm-200)",
        300: "var(--colors-gray-gray-warm-300)",
        400: "var(--colors-gray-gray-warm-400)",
        500: "var(--colors-gray-gray-warm-500)",
        600: "var(--colors-gray-gray-warm-600)",
        700: "var(--colors-gray-gray-warm-700)",
        800: "var(--colors-gray-gray-warm-800)",
        900: "var(--colors-gray-gray-warm-900)",
        950: "var(--colors-gray-gray-warm-950)",
      },
    },
  },
